...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectId1 : IEquatable<ProjectId1>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ProjectId1)obj);
        }

        /// <summary>
        /// Returns true if ProjectId1 instances are equal
        /// </summary>
        /// <param name="other">Instance of ProjectId1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectId1 other)
        {
        ...
        public static bool operator ==(ProjectId1 left, ProjectId1 right)
        {
