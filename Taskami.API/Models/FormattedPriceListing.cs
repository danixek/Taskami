...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class FormattedPriceListing : IEquatable<FormattedPriceListing>
    {

        /// <summary>
        /// Gets or Sets BillingCycle
        /// </summary>
        [TypeConverter(typeof(CustomEnumConverter<BillingCycleEnum>))]
        ...
        /// </summary>
        [Required]
        [DataMember(Name="billing_cycle", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FormattedPriceListing)obj);
        }

        /// <summary>
        /// Returns true if FormattedPriceListing instances are equal
        /// </summary>
        /// <param name="other">Instance of FormattedPriceListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FormattedPriceListing other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + BillingCycle.GetHashCode();
                    if (Prices != null)
        ...
        public static bool operator ==(FormattedPriceListing left, FormattedPriceListing right)
        {
