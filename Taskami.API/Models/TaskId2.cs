...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TaskId2 : IEquatable<TaskId2>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TaskId2)obj);
        }

        /// <summary>
        /// Returns true if TaskId2 instances are equal
        /// </summary>
        /// <param name="other">Instance of TaskId2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskId2 other)
        {
        ...
        public static bool operator ==(TaskId2 left, TaskId2 right)
        {
