...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class IDMapping : IEquatable<IDMapping>
    {
        /// <summary>
        /// Gets or Sets OldId
        /// </summary>
        [Required]
        [DataMember(Name="old_id", EmitDefaultValue=true)]
        ...
        /// </summary>
        [Required]
        [DataMember(Name="new_id", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((IDMapping)obj);
        }

        /// <summary>
        /// Returns true if IDMapping instances are equal
        /// </summary>
        /// <param name="other">Instance of IDMapping to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(IDMapping left, IDMapping right)
        {
