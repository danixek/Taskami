...
{ 
    ...
    public partial class ProjectsResponse : IEquatable<ProjectsResponse>
    {
        ...
        /// </summary>
        [Required]
        [DataMember(Name="workspace_projects", EmitDefaultValue=false)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ProjectsResponse)obj);
        }

        /// <summary>
        /// Returns true if ProjectsResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ProjectsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectsResponse other)
        {
            ...
            return 
                ...
                (
                    WorkspaceProjects == other.WorkspaceProjects ||
                    WorkspaceProjects != null &&
                    other.WorkspaceProjects != null &&
                    WorkspaceProjects.SequenceEqual(other.WorkspaceProjects)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + WorkspaceProjects.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(ProjectsResponse left, ProjectsResponse right)
        {
