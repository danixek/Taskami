...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ParentProjectId : IEquatable<ParentProjectId>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ParentProjectId)obj);
        }

        /// <summary>
        /// Returns true if ParentProjectId instances are equal
        /// </summary>
        /// <param name="other">Instance of ParentProjectId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParentProjectId other)
        {
        ...
        public static bool operator ==(ParentProjectId left, ParentProjectId right)
        {
