...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TodoistAppsApiSyncRestWorkspacesBody2 : IEquatable<TodoistAppsApiSyncRestWorkspacesBody2>
    {
        /// <summary>
        /// Gets or Sets InviteCode
        /// </summary>
        [DataMember(Name="invite_code", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TodoistAppsApiSyncRestWorkspacesBody2)obj);
        }

        /// <summary>
        /// Returns true if TodoistAppsApiSyncRestWorkspacesBody2 instances are equal
        /// </summary>
        /// <param name="other">Instance of TodoistAppsApiSyncRestWorkspacesBody2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TodoistAppsApiSyncRestWorkspacesBody2 other)
        {
        ...
        public static bool operator ==(TodoistAppsApiSyncRestWorkspacesBody2 left, TodoistAppsApiSyncRestWorkspacesBody2 right)
        {
