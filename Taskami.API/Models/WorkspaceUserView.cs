...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class WorkspaceUserView : IEquatable<WorkspaceUserView>
    {
        /// <summary>
        /// Gets or Sets UserId
        /// </summary>
        ...
        /// </summary>
        [DataMember(Name="custom_sorting_applied", EmitDefaultValue=true)]
        public bool CustomSortingApplied { get; set; } = false;
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((WorkspaceUserView)obj);
        }

        /// <summary>
        /// Returns true if WorkspaceUserView instances are equal
        /// </summary>
        /// <param name="other">Instance of WorkspaceUserView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkspaceUserView other)
        {
            ...
            return 
                ...
                (
                    CustomSortingApplied == other.CustomSortingApplied ||
                    
                    CustomSortingApplied.Equals(other.CustomSortingApplied)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + CustomSortingApplied.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(WorkspaceUserView left, WorkspaceUserView right)
        {
