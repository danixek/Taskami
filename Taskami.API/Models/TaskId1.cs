...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TaskId1 : IEquatable<TaskId1>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TaskId1)obj);
        }

        /// <summary>
        /// Returns true if TaskId1 instances are equal
        /// </summary>
        /// <param name="other">Instance of TaskId1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskId1 other)
        {
        ...
        public static bool operator ==(TaskId1 left, TaskId1 right)
        {
