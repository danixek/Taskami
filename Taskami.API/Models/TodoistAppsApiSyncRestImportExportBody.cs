...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TodoistAppsApiSyncRestImportExportBody : IEquatable<TodoistAppsApiSyncRestImportExportBody>
    {
        /// <summary>
        /// Gets or Sets ObjType
        /// </summary>
        [Required]
        [DataMember(Name="obj_type", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TodoistAppsApiSyncRestImportExportBody)obj);
        }

        /// <summary>
        /// Returns true if TodoistAppsApiSyncRestImportExportBody instances are equal
        /// </summary>
        /// <param name="other">Instance of TodoistAppsApiSyncRestImportExportBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TodoistAppsApiSyncRestImportExportBody other)
        {
            ...
            return 
                (
                    ...
                    ObjType.Equals(other.ObjType)
                ) && 
                (
                    ObjId == other.ObjId ||
                    ObjId != null &&
                    ObjId.Equals(other.ObjId)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ObjType.GetHashCode();
                    if (ObjId != null)
                    hashCode = hashCode * 59 + ObjId.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(TodoistAppsApiSyncRestImportExportBody left, TodoistAppsApiSyncRestImportExportBody right)
        {
