...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TodoistAppsApiRestCommentsBody1 : IEquatable<TodoistAppsApiRestCommentsBody1>
    {
        /// <summary>
        ...
        public ProjectId4 ProjectId { get; set; }

        /// <summary>
        /// Gets or Sets TaskId
        /// </summary>
        [DataMember(Name="task_id", EmitDefaultValue=true)]
        public TaskId3 TaskId { get; set; }
        ...
        public List<int> UidsToNotify { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TodoistAppsApiRestCommentsBody1)obj);
        }

        /// <summary>
        /// Returns true if TodoistAppsApiRestCommentsBody1 instances are equal
        /// </summary>
        /// <param name="other">Instance of TodoistAppsApiRestCommentsBody1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TodoistAppsApiRestCommentsBody1 other)
        {
        ...
        public static bool operator ==(TodoistAppsApiRestCommentsBody1 left, TodoistAppsApiRestCommentsBody1 right)
        {
