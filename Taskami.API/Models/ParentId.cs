...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ParentId : IEquatable<ParentId>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ParentId)obj);
        }

        /// <summary>
        /// Returns true if ParentId instances are equal
        /// </summary>
        /// <param name="other">Instance of ParentId to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(ParentId left, ParentId right)
        {
