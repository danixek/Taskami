...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class FormattedPrice : IEquatable<FormattedPrice>
    {
        /// <summary>
        ...
        /// </summary>
        [Required]
        [DataMember(Name="tax_behavior", EmitDefaultValue=false)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FormattedPrice)obj);
        }

        /// <summary>
        /// Returns true if FormattedPrice instances are equal
        /// </summary>
        /// <param name="other">Instance of FormattedPrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FormattedPrice other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (TaxBehavior != null)
                    hashCode = hashCode * 59 + TaxBehavior.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(FormattedPrice left, FormattedPrice right)
        {
