...
{ 
    ...
    public partial class UsersResponse : IEquatable<UsersResponse>
    {
        ...
        /// </summary>
        [Required]
        [DataMember(Name="workspace_users", EmitDefaultValue=false)]
        ...
        public bool Equals(UsersResponse other)
        {
            ...
            return 
                ...
                (
                    WorkspaceUsers == other.WorkspaceUsers ||
                    WorkspaceUsers != null &&
                    other.WorkspaceUsers != null &&
                    WorkspaceUsers.SequenceEqual(other.WorkspaceUsers)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + WorkspaceUsers.GetHashCode();
                return hashCode;
            }
        }
