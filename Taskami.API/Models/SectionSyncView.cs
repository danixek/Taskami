...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SectionSyncView : IEquatable<SectionSyncView>
    {
        /// <summary>
        /// Gets or Sets Id
        /// </summary>
        ...
        /// </summary>
        [Required]
        [DataMember(Name="section_order", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SectionSyncView)obj);
        }

        /// <summary>
        /// Returns true if SectionSyncView instances are equal
        /// </summary>
        /// <param name="other">Instance of SectionSyncView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SectionSyncView other)
        {
            ...
            return 
                ...
                (
                    ...
                    SectionOrder.Equals(other.SectionOrder)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + SectionOrder.GetHashCode();
        ...
        public static bool operator ==(SectionSyncView left, SectionSyncView right)
        {
