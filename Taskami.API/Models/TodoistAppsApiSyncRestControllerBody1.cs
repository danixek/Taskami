...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TodoistAppsApiSyncRestControllerBody1 : IEquatable<TodoistAppsApiSyncRestControllerBody1>
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="dont_notify", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TodoistAppsApiSyncRestControllerBody1)obj);
        }

        /// <summary>
        /// Returns true if TodoistAppsApiSyncRestControllerBody1 instances are equal
        /// </summary>
        /// <param name="other">Instance of TodoistAppsApiSyncRestControllerBody1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TodoistAppsApiSyncRestControllerBody1 other)
        {
            ...
            return 
                ...
                (
                    DontNotify == other.DontNotify ||
                    DontNotify != null &&
                    DontNotify.Equals(other.DontNotify)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (DontNotify != null)
                    hashCode = hashCode * 59 + DontNotify.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(TodoistAppsApiSyncRestControllerBody1 left, TodoistAppsApiSyncRestControllerBody1 right)
        {
