...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class UploadResult : IEquatable<UploadResult>
    {
        /// <summary>
        ...
        /// </summary>
        [Required]
        [DataMember(Name="file_size", EmitDefaultValue=true)]
        ...
        /// </summary>
        [DataMember(Name="image_width", EmitDefaultValue=true)]
        public int? ImageWidth { get; set; }

        /// <summary>
        /// Gets or Sets ImageHeight
        /// </summary>
        [DataMember(Name="image_height", EmitDefaultValue=true)]
        ...
        /// </summary>
        [TypeConverter(typeof(CustomEnumConverter<UploadStateEnum>))]
        ...
        /// Gets or Sets UploadState
        /// </summary>
        [DataMember(Name="upload_state", EmitDefaultValue=true)]
        public UploadStateEnum UploadState { get; set; } = UploadStateEnum.PendingEnum;
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((UploadResult)obj);
        }

        /// <summary>
        /// Returns true if UploadResult instances are equal
        /// </summary>
        /// <param name="other">Instance of UploadResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UploadResult other)
        {
            ...
            return 
                ...
                (
                    ...
                    UploadState.Equals(other.UploadState)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (ImageHeight != null)
                    hashCode = hashCode * 59 + ImageHeight.GetHashCode();
                    
                    hashCode = hashCode * 59 + UploadState.GetHashCode();
                return hashCode;
            }
        }
