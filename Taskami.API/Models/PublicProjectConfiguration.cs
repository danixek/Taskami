...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PublicProjectConfiguration : IEquatable<PublicProjectConfiguration>
    {
        /// <summary>
        /// Gets or Sets HideCollaboratorDetails
        /// </summary>
        [Required]
        [DataMember(Name="hide_collaborator_details", EmitDefaultValue=true)]
        ...
        /// </summary>
        [Required]
        [DataMember(Name="disable_duplication", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PublicProjectConfiguration)obj);
        }

        /// <summary>
        /// Returns true if PublicProjectConfiguration instances are equal
        /// </summary>
        /// <param name="other">Instance of PublicProjectConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicProjectConfiguration other)
        {
            ...
            return 
                (
                    HideCollaboratorDetails == other.HideCollaboratorDetails ||
                    
                    HideCollaboratorDetails.Equals(other.HideCollaboratorDetails)
                ) && 
                (
                    DisableDuplication == other.DisableDuplication ||
                    
                    DisableDuplication.Equals(other.DisableDuplication)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + HideCollaboratorDetails.GetHashCode();
                    
                    hashCode = hashCode * 59 + DisableDuplication.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(PublicProjectConfiguration left, PublicProjectConfiguration right)
        {
