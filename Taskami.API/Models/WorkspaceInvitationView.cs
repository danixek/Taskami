...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class WorkspaceInvitationView : IEquatable<WorkspaceInvitationView>
    {
        /// <summary>
        ...
        [Required]
        [DataMember(Name="is_existing_user", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((WorkspaceInvitationView)obj);
        }

        /// <summary>
        /// Returns true if WorkspaceInvitationView instances are equal
        /// </summary>
        /// <param name="other">Instance of WorkspaceInvitationView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkspaceInvitationView other)
        {
            ...
            return 
                ...
                (
                    IsExistingUser == other.IsExistingUser ||
                    
                    IsExistingUser.Equals(other.IsExistingUser)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + IsExistingUser.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(WorkspaceInvitationView left, WorkspaceInvitationView right)
        {
