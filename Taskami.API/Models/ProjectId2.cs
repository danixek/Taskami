...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectId2 : IEquatable<ProjectId2>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ProjectId2)obj);
        }

        /// <summary>
        /// Returns true if ProjectId2 instances are equal
        /// </summary>
        /// <param name="other">Instance of ProjectId2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectId2 other)
        {
        ...
        public static bool operator ==(ProjectId2 left, ProjectId2 right)
        {
