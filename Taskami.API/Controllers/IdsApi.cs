...
{ 
    ...
    /// </summary>
    [ApiController]
    public class IdsApiController : ControllerBase
    { 
        /// <summary>
        /// Id Mappings
        /// </summary>
        /// <remarks>Translates IDs from v1 to v2 or vice versa.  IDs are not unique across object types, hence the need to specify the object type.  When V1 ids are provided, the function will return the corresponding V2 ids, if they exist, and vice versa.  When no objects are found, an empty list is returned.</remarks>
        ...
        [HttpGet]
        [Route("/api/v1/id_mappings/{obj_name}/{obj_ids}")]
        [ValidateModelState]
        [SwaggerOperation("IdMappingsApiV1IdMappingsObjNameObjIdsGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<IDMapping>), description: "Successful Response")]
        public virtual IActionResult IdMappingsApiV1IdMappingsObjNameObjIdsGet([FromRoute (Name = "obj_name")][Required]string objName, [FromRoute (Name = "obj_ids")][Required]string objIds)
        {
            ...
            ? JsonConvert.DeserializeObject<List<IDMapping>>(exampleJson)
            : default;
