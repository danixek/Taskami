...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <remarks>Tokens obtained via the old email/password authentication method can be migrated to the new OAuth access token. Migrating your users&#39; personal tokens will allow users to see your app in their Todoist Settings page and give them the ability to manage their app authorization.  A successful response has &#x60;200 OK&#x60; status and &#x60;application/json&#x60; Content-Type.</remarks>
        ...
        [HttpPost]
        [Route("/api/v1/access_tokens/migrate_personal_token")]
        [Consumes("application/json")]
        [ValidateModelState]
        [SwaggerOperation("MigratePersonalTokenApiV1AccessTokensMigratePersonalTokenPost")]
        [SwaggerResponse(statusCode: 200, type: typeof(MigratePersonalTokenResponse), description: "Successful Response")]
        public virtual IActionResult MigratePersonalTokenApiV1AccessTokensMigratePersonalTokenPost([FromBody]TodoistAppsAppPlatformControllersAccessTokenBody todoistAppsAppPlatformControllersAccessTokenBody)
        {
            ...
            ? JsonConvert.DeserializeObject<MigratePersonalTokenResponse>(exampleJson)
            : default;
        ...
        /// </summary>
        /// <remarks>Revoke the access tokens obtained via OAuth</remarks>
        ...
        /// <response code="404">Not Found</response>
        [HttpDelete]
        [Route("/api/v1/access_tokens")]
        [ValidateModelState]
        [SwaggerOperation("RevokeAccessTokenApiApiV1AccessTokensDelete")]
        [SwaggerResponse(statusCode: 200, type: typeof(Object), description: "Successful Response")]
        public virtual IActionResult RevokeAccessTokenApiApiV1AccessTokensDelete([FromQuery (Name = "client_id")][Required()]string clientId, [FromQuery (Name = "client_secret")][Required()]string clientSecret, [FromQuery (Name = "access_token")][Required()]string accessToken)
        {
