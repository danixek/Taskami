...
namespace Org.OpenAPITools.Client
{
    ...
    public struct Option<TType>
    {
        ...
        public static implicit operator Option<TType>(Option<List?> v) => throw new NotImplementedException();

        public static implicit operator Option<TType>(Option<Dictionary?> v) => throw new NotImplementedException();
    }
}