...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class TodoistAppsApiRestLabelsBody2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TodoistAppsApiRestLabelsBody2" /> class.
        /// </summary>
        /// <param name="name">name</param>
        /// <param name="newName">newName</param>
        [JsonConstructor]
        public TodoistAppsApiRestLabelsBody2(string name, string newName)
        {
            Name = name;
            NewName = newName;
            OnCreated();
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TodoistAppsApiRestLabelsBody2 {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="TodoistAppsApiRestLabelsBody2" />
    /// </summary>
    public class TodoistAppsApiRestLabelsBody2JsonConverter : JsonConverter<TodoistAppsApiRestLabelsBody2>
    {
        /// <summary>
        /// Deserializes json to <see cref="TodoistAppsApiRestLabelsBody2" />
        /// </summary>
        ...
        public override TodoistAppsApiRestLabelsBody2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class TodoistAppsApiRestLabelsBody2.", nameof(name));

            if (!newName.IsSet)
                throw new ArgumentException("Property is required for class TodoistAppsApiRestLabelsBody2.", nameof(newName));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class TodoistAppsApiRestLabelsBody2.");

            if (newName.IsSet && newName.Value == null)
                throw new ArgumentNullException(nameof(newName), "Property is not nullable for class TodoistAppsApiRestLabelsBody2.");

            return new TodoistAppsApiRestLabelsBody2(name.Value!, newName.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="TodoistAppsApiRestLabelsBody2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="todoistAppsApiRestLabelsBody2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TodoistAppsApiRestLabelsBody2 todoistAppsApiRestLabelsBody2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, todoistAppsApiRestLabelsBody2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TodoistAppsApiRestLabelsBody2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="todoistAppsApiRestLabelsBody2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TodoistAppsApiRestLabelsBody2 todoistAppsApiRestLabelsBody2, JsonSerializerOptions jsonSerializerOptions)
        {
            if (todoistAppsApiRestLabelsBody2.Name == null)
                throw new ArgumentNullException(nameof(todoistAppsApiRestLabelsBody2.Name), "Property is required for class TodoistAppsApiRestLabelsBody2.");

            if (todoistAppsApiRestLabelsBody2.NewName == null)
                throw new ArgumentNullException(nameof(todoistAppsApiRestLabelsBody2.NewName), "Property is required for class TodoistAppsApiRestLabelsBody2.");

            writer.WriteString("name", todoistAppsApiRestLabelsBody2.Name);

            writer.WriteString("new_name", todoistAppsApiRestLabelsBody2.NewName);
        }
    }
}
