...
namespace Org.OpenAPITools.Model
{
    ...
    /// ParentItemId
    /// </summary>
    public partial class ParentItemId : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParentItemId" /> class.
        /// </summary>
        /// <param name="int"></param>
        /// <param name="string"></param>
        internal ParentItemId(Option<int?> @int, Option<string?> @string)
        {
            IntOption = @int;
            StringOption = @string;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="ParentItemId" />
    /// </summary>
    public class ParentItemIdJsonConverter : JsonConverter<ParentItemId>
    {
        /// <summary>
        /// Deserializes json to <see cref="ParentItemId" />
        /// </summary>
        ...
        public override ParentItemId Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ParentItemId(varIntParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="ParentItemId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="parentItemId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ParentItemId parentItemId, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (parentItemId.IntOption.IsSet && parentItemId.IntOption.Value != null)
                writer.WriteNumber("Id", parentItemId.IntOption.Value.Value);

            if (parentItemId.StringOption.IsSet && parentItemId.StringOption.Value != null)
                writer.WriteString("Id", parentItemId.StringOption.Value);

            WriteProperties(writer, parentItemId, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ParentItemId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="parentItemId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ParentItemId parentItemId, JsonSerializerOptions jsonSerializerOptions)
        {
