...
namespace Org.OpenAPITools.Model
{
    ...
    /// Labels
    /// </summary>
    public partial class Labels : IValidatableObject
    {
        /// <summary>
        ...
        internal Labels(Option<List?> list, Option<Undefined?> undefined)
        {
            ListOption = list;
    ...
    /// <summary>
    /// A Json converter for type <see cref="Labels" />
    /// </summary>
    public class LabelsJsonConverter : JsonConverter<Labels>
    {
        /// <summary>
        /// Deserializes json to <see cref="Labels" />
        /// </summary>
        ...
        public override Labels Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Labels(listParsedValue, undefinedParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Labels" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="labels"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Labels labels, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (labels.ListOption.IsSet && labels.ListOption.Value != null)

            if (labels.UndefinedOption.IsSet && labels.UndefinedOption.Value != null)
            {
                UndefinedJsonConverter UndefinedJsonConverter = (UndefinedJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(labels.UndefinedOption.Value.GetType()));
                UndefinedJsonConverter.WriteProperties(writer, labels.UndefinedOption.Value, jsonSerializerOptions);
            }

            WriteProperties(writer, labels, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Labels" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="labels"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Labels labels, JsonSerializerOptions jsonSerializerOptions)
        {
