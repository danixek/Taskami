...
namespace Org.OpenAPITools.Model
{
    ...
    /// SectionId2
    /// </summary>
    public partial class SectionId2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SectionId2" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        internal SectionId2(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="SectionId2" />
    /// </summary>
    public class SectionId2JsonConverter : JsonConverter<SectionId2>
    {
        /// <summary>
        /// Deserializes json to <see cref="SectionId2" />
        /// </summary>
        ...
        public override SectionId2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new SectionId2(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="SectionId2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sectionId2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SectionId2 sectionId2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (sectionId2.StringOption.IsSet && sectionId2.StringOption.Value != null)
                writer.WriteString("1", sectionId2.StringOption.Value);

            if (sectionId2.IntOption.IsSet && sectionId2.IntOption.Value != null)
                writer.WriteNumber("3", sectionId2.IntOption.Value.Value);

            WriteProperties(writer, sectionId2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SectionId2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sectionId2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SectionId2 sectionId2, JsonSerializerOptions jsonSerializerOptions)
        {
