...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class DueDate : IValidatableObject
    {
        ...
        internal DueDate(Option<string?> @string, Option<Undefined?> undefined)
        {
            StringOption = @string;
    ...
    /// <summary>
    /// A Json converter for type <see cref="DueDate" />
    /// </summary>
    public class DueDateJsonConverter : JsonConverter<DueDate>
    {
        /// <summary>
        /// Deserializes json to <see cref="DueDate" />
        /// </summary>
        ...
        public override DueDate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new DueDate(varStringParsedValue, undefinedParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="DueDate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dueDate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DueDate dueDate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (dueDate.StringOption.IsSet && dueDate.StringOption.Value != null)
                writer.WriteString("inner", dueDate.StringOption.Value);

            if (dueDate.UndefinedOption.IsSet && dueDate.UndefinedOption.Value != null)
            {
                UndefinedJsonConverter UndefinedJsonConverter = (UndefinedJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(dueDate.UndefinedOption.Value.GetType()));
                UndefinedJsonConverter.WriteProperties(writer, dueDate.UndefinedOption.Value, jsonSerializerOptions);
            }

            WriteProperties(writer, dueDate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DueDate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dueDate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DueDate dueDate, JsonSerializerOptions jsonSerializerOptions)
        {
