...
namespace Org.OpenAPITools.Model
{
    ...
    /// ParentProjectId
    /// </summary>
    public partial class ParentProjectId : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParentProjectId" /> class.
        /// </summary>
        /// <param name="int"></param>
        /// <param name="string"></param>
        internal ParentProjectId(Option<int?> @int, Option<string?> @string)
        {
            IntOption = @int;
            StringOption = @string;
            OnCreated();
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ParentProjectId {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ParentProjectId" />
    /// </summary>
    public class ParentProjectIdJsonConverter : JsonConverter<ParentProjectId>
    {
        /// <summary>
        /// Deserializes json to <see cref="ParentProjectId" />
        /// </summary>
        ...
        public override ParentProjectId Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ParentProjectId(varIntParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="ParentProjectId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="parentProjectId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ParentProjectId parentProjectId, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (parentProjectId.IntOption.IsSet && parentProjectId.IntOption.Value != null)
                writer.WriteNumber("Id", parentProjectId.IntOption.Value.Value);

            if (parentProjectId.StringOption.IsSet && parentProjectId.StringOption.Value != null)
                writer.WriteString("Id", parentProjectId.StringOption.Value);

            WriteProperties(writer, parentProjectId, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ParentProjectId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="parentProjectId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ParentProjectId parentProjectId, JsonSerializerOptions jsonSerializerOptions)
        {
