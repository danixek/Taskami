...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Duration : IValidatableObject
    {
        ...
        internal Duration(Option<int?> @int, Option<Undefined?> undefined)
        {
            IntOption = @int;
    ...
    public class DurationJsonConverter : JsonConverter<Duration>
    {
        ...
        public override Duration Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Duration(varIntParsedValue, undefinedParsedValue);
        }
        ...
        public override void Write(Utf8JsonWriter writer, Duration duration, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (duration.IntOption.IsSet && duration.IntOption.Value != null)
                writer.WriteNumber("Priority", duration.IntOption.Value.Value);

            if (duration.UndefinedOption.IsSet && duration.UndefinedOption.Value != null)
            {
                UndefinedJsonConverter UndefinedJsonConverter = (UndefinedJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(duration.UndefinedOption.Value.GetType()));
                UndefinedJsonConverter.WriteProperties(writer, duration.UndefinedOption.Value, jsonSerializerOptions);
            }
