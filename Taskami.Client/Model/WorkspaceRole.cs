...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    /// <value>Role of the user inside the workspace</value>
    ...
    /// <summary>
    /// Converts <see cref="WorkspaceRole"/> to and from the JSON value
    /// </summary>
    public static class WorkspaceRoleValueConverter
    {
        /// <summary>
        /// Parses a given value to <see cref="WorkspaceRole"/>
        /// </summary>
        ...
        public static WorkspaceRole FromString(string value)
        {
            ...
            throw new NotImplementedException($"Could not convert value to type WorkspaceRole: '{value}'");
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static WorkspaceRole? FromStringOrDefault(string value)
        {
            if (value.Equals("ADMIN"))
                return WorkspaceRole.ADMIN;
        ...
        /// <summary>
        /// Converts the <see cref="WorkspaceRole"/> to the json value
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static string ToJsonValue(WorkspaceRole value)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="WorkspaceRole"/>
    /// </summary>
    /// <exception cref="NotImplementedException"></exception>
    public class WorkspaceRoleJsonConverter : JsonConverter<WorkspaceRole>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override WorkspaceRole Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            string? rawValue = reader.GetString();

            WorkspaceRole? result = rawValue == null
                ? null
                : WorkspaceRoleValueConverter.FromStringOrDefault(rawValue);
        ...
        /// <summary>
        /// Writes the WorkspaceRole to the json writer
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="workspaceRole"></param>
        /// <param name="options"></param>
        public override void Write(Utf8JsonWriter writer, WorkspaceRole workspaceRole, JsonSerializerOptions options)
        {
            writer.WriteStringValue(workspaceRole.ToString());
        }
    }
    ...
    /// A Json converter for type <see cref="WorkspaceRole"/>
    /// </summary>
    public class WorkspaceRoleNullableJsonConverter : JsonConverter<WorkspaceRole?>
    {
        /// <summary>
        /// Returns a WorkspaceRole from the Json object
        /// </summary>
        /// <param name="reader"></param>
        /// <param name="typeToConvert"></param>
        /// <param name="options"></param>
        ...
        public override void Write(Utf8JsonWriter writer, WorkspaceRole? workspaceRole, JsonSerializerOptions options)
        {
            writer.WriteStringValue(workspaceRole?.ToString() ?? "null");
        }
    }
}
