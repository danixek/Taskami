...
namespace Org.OpenAPITools.Model
{
    ...
    /// TaskId2
    /// </summary>
    public partial class TaskId2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskId2" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        internal TaskId2(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="TaskId2" />
    /// </summary>
    public class TaskId2JsonConverter : JsonConverter<TaskId2>
    {
        /// <summary>
        /// Deserializes json to <see cref="TaskId2" />
        /// </summary>
        ...
        public override TaskId2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TaskId2(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="TaskId2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taskId2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TaskId2 taskId2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (taskId2.StringOption.IsSet && taskId2.StringOption.Value != null)
                writer.WriteString("inner", taskId2.StringOption.Value);

            if (taskId2.IntOption.IsSet && taskId2.IntOption.Value != null)
                writer.WriteNumber("3", taskId2.IntOption.Value.Value);

            WriteProperties(writer, taskId2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TaskId2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taskId2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TaskId2 taskId2, JsonSerializerOptions jsonSerializerOptions)
        {
