...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class TodoistAppsApiRestLabelsBody1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TodoistAppsApiRestLabelsBody1" /> class.
        /// </summary>
        /// <param name="name">name</param>
        [JsonConstructor]
        public TodoistAppsApiRestLabelsBody1(string name)
        {
            Name = name;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TodoistAppsApiRestLabelsBody1 {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="TodoistAppsApiRestLabelsBody1" />
    /// </summary>
    public class TodoistAppsApiRestLabelsBody1JsonConverter : JsonConverter<TodoistAppsApiRestLabelsBody1>
    {
        /// <summary>
        /// Deserializes json to <see cref="TodoistAppsApiRestLabelsBody1" />
        /// </summary>
        ...
        public override TodoistAppsApiRestLabelsBody1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class TodoistAppsApiRestLabelsBody1.", nameof(name));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class TodoistAppsApiRestLabelsBody1.");

            return new TodoistAppsApiRestLabelsBody1(name.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="TodoistAppsApiRestLabelsBody1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="todoistAppsApiRestLabelsBody1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TodoistAppsApiRestLabelsBody1 todoistAppsApiRestLabelsBody1, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, todoistAppsApiRestLabelsBody1, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TodoistAppsApiRestLabelsBody1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="todoistAppsApiRestLabelsBody1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TodoistAppsApiRestLabelsBody1 todoistAppsApiRestLabelsBody1, JsonSerializerOptions jsonSerializerOptions)
        {
            if (todoistAppsApiRestLabelsBody1.Name == null)
                throw new ArgumentNullException(nameof(todoistAppsApiRestLabelsBody1.Name), "Property is required for class TodoistAppsApiRestLabelsBody1.");

            writer.WriteString("name", todoistAppsApiRestLabelsBody1.Name);
        }
    }
}
