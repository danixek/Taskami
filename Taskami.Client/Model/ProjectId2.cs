...
namespace Org.OpenAPITools.Model
{
    ...
    /// ProjectId2
    /// </summary>
    public partial class ProjectId2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectId2" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        internal ProjectId2(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="ProjectId2" />
    /// </summary>
    public class ProjectId2JsonConverter : JsonConverter<ProjectId2>
    {
        /// <summary>
        /// Deserializes json to <see cref="ProjectId2" />
        /// </summary>
        ...
        public override ProjectId2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ProjectId2(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="ProjectId2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectId2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProjectId2 projectId2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (projectId2.StringOption.IsSet && projectId2.StringOption.Value != null)
                writer.WriteString("inner", projectId2.StringOption.Value);

            if (projectId2.IntOption.IsSet && projectId2.IntOption.Value != null)
                writer.WriteNumber("3", projectId2.IntOption.Value.Value);

            WriteProperties(writer, projectId2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ProjectId2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectId2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ProjectId2 projectId2, JsonSerializerOptions jsonSerializerOptions)
        {
