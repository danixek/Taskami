...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ProjectId : IValidatableObject
    {
        ...
        internal ProjectId(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="ProjectId" />
    /// </summary>
    public class ProjectIdJsonConverter : JsonConverter<ProjectId>
    {
        /// <summary>
        /// Deserializes json to <see cref="ProjectId" />
        /// </summary>
        ...
        public override ProjectId Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ProjectId(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="ProjectId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProjectId projectId, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (projectId.StringOption.IsSet && projectId.StringOption.Value != null)
                writer.WriteString("1", projectId.StringOption.Value);

            if (projectId.IntOption.IsSet && projectId.IntOption.Value != null)
                writer.WriteNumber("3", projectId.IntOption.Value.Value);

            WriteProperties(writer, projectId, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ProjectId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ProjectId projectId, JsonSerializerOptions jsonSerializerOptions)
        {
