...
namespace Org.OpenAPITools.Model
{
    ...
    /// PaginatedListStr
    /// </summary>
    public partial class PaginatedListStr : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedListStr" /> class.
        /// </summary>
        /// <param name="results">results</param>
        /// <param name="nextCursor">nextCursor</param>
        [JsonConstructor]
        public PaginatedListStr(List<string> results, string? nextCursor = default)
        {
            Results = results;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedListStr {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="PaginatedListStr" />
    /// </summary>
    public class PaginatedListStrJsonConverter : JsonConverter<PaginatedListStr>
    {
        /// <summary>
        /// Deserializes json to <see cref="PaginatedListStr" />
        /// </summary>
        ...
        public override PaginatedListStr Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!results.IsSet)
                throw new ArgumentException("Property is required for class PaginatedListStr.", nameof(results));

            if (!nextCursor.IsSet)
                throw new ArgumentException("Property is required for class PaginatedListStr.", nameof(nextCursor));

            if (results.IsSet && results.Value == null)
                throw new ArgumentNullException(nameof(results), "Property is not nullable for class PaginatedListStr.");

            return new PaginatedListStr(results.Value!, nextCursor.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="PaginatedListStr" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paginatedListStr"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PaginatedListStr paginatedListStr, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, paginatedListStr, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PaginatedListStr" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paginatedListStr"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PaginatedListStr paginatedListStr, JsonSerializerOptions jsonSerializerOptions)
        {
            if (paginatedListStr.Results == null)
                throw new ArgumentNullException(nameof(paginatedListStr.Results), "Property is required for class PaginatedListStr.");

            writer.WritePropertyName("results");
            JsonSerializer.Serialize(writer, paginatedListStr.Results, jsonSerializerOptions);
            if (paginatedListStr.NextCursor != null)
                writer.WriteString("next_cursor", paginatedListStr.NextCursor);
            else
