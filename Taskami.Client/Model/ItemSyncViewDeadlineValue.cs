...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class ItemSyncViewDeadlineValue : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemSyncViewDeadlineValue" /> class.
        /// </summary>
        /// <param name="string"></param>
        internal ItemSyncViewDeadlineValue(Option<string?> @string)
        {
            StringOption = @string;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ItemSyncViewDeadlineValue {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ItemSyncViewDeadlineValue" />
    /// </summary>
    public class ItemSyncViewDeadlineValueJsonConverter : JsonConverter<ItemSyncViewDeadlineValue>
    {
        /// <summary>
        /// Deserializes json to <see cref="ItemSyncViewDeadlineValue" />
        /// </summary>
        ...
        public override ItemSyncViewDeadlineValue Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ItemSyncViewDeadlineValue(varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="ItemSyncViewDeadlineValue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="itemSyncViewDeadlineValue"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ItemSyncViewDeadlineValue itemSyncViewDeadlineValue, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (itemSyncViewDeadlineValue.StringOption.IsSet && itemSyncViewDeadlineValue.StringOption.Value != null)
                writer.WriteString("1", itemSyncViewDeadlineValue.StringOption.Value);

            WriteProperties(writer, itemSyncViewDeadlineValue, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ItemSyncViewDeadlineValue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="itemSyncViewDeadlineValue"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ItemSyncViewDeadlineValue itemSyncViewDeadlineValue, JsonSerializerOptions jsonSerializerOptions)
        {
