...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class CommentId : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommentId" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        internal CommentId(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="CommentId" />
    /// </summary>
    public class CommentIdJsonConverter : JsonConverter<CommentId>
    {
        /// <summary>
        /// Deserializes json to <see cref="CommentId" />
        /// </summary>
        ...
        public override CommentId Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new CommentId(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="CommentId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="commentId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CommentId commentId, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (commentId.StringOption.IsSet && commentId.StringOption.Value != null)
                writer.WriteString("1", commentId.StringOption.Value);

            if (commentId.IntOption.IsSet && commentId.IntOption.Value != null)
                writer.WriteNumber("3", commentId.IntOption.Value.Value);

            WriteProperties(writer, commentId, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CommentId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="commentId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CommentId commentId, JsonSerializerOptions jsonSerializerOptions)
        {
