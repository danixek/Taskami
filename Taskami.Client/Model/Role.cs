...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Role : IValidatableObject
    {
        ...
        internal Role(Option<CollaboratorRole?> collaboratorRole, Option<Undefined?> undefined)
        {
            CollaboratorRoleOption = collaboratorRole;
        ...
        /// <summary>
        /// Used to track the state of CollaboratorRole
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<CollaboratorRole?> CollaboratorRoleOption { get; private set; }

        /// <summary>
        /// Gets or Sets CollaboratorRole
        /// </summary>
        public CollaboratorRole? CollaboratorRole { get { return this.CollaboratorRoleOption; } set { this.CollaboratorRoleOption = new(value); } }

        /// <summary>
        /// Used to track the state of Undefined
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<Undefined?> UndefinedOption { get; private set; }

        /// <summary>
        /// Gets or Sets Undefined
        /// </summary>
        public Undefined? Undefined { get { return this.UndefinedOption; } set { this.UndefinedOption = new(value); } }
    ...
    public class RoleJsonConverter : JsonConverter<Role>
    {
        ...
        public override Role Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            CollaboratorRole? collaboratorRole = default;
            ...
            while (utf8JsonReaderAnyOf.Read())
            {
                ...
                {
                    Utf8JsonReader utf8JsonReaderCollaboratorRole = utf8JsonReader;
                    ClientUtils.TryDeserialize<CollaboratorRole?>(ref utf8JsonReaderCollaboratorRole, jsonSerializerOptions, out collaboratorRole);

                    Utf8JsonReader utf8JsonReaderUndefined = utf8JsonReader;
                    ClientUtils.TryDeserialize<Undefined?>(ref utf8JsonReaderUndefined, jsonSerializerOptions, out undefined);
                }
            }
            ...
            Option<CollaboratorRole?> collaboratorRoleParsedValue = collaboratorRole == null
                ? default
                : new Option<CollaboratorRole?>(collaboratorRole);
            Option<Undefined?> undefinedParsedValue = undefined == null
                ? default
                : new Option<Undefined?>(undefined);

            return new Role(collaboratorRoleParsedValue, undefinedParsedValue);
        }
        ...
        public override void Write(Utf8JsonWriter writer, Role role, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (role.CollaboratorRoleOption.IsSet && role.CollaboratorRoleOption.Value != null)
            {
                CollaboratorRoleJsonConverter CollaboratorRoleJsonConverter = (CollaboratorRoleJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(role.CollaboratorRoleOption.Value.GetType()));
                CollaboratorRoleJsonConverter.WriteProperties(writer, role.CollaboratorRoleOption.Value, jsonSerializerOptions);
            }

            if (role.UndefinedOption.IsSet && role.UndefinedOption.Value != null)
            {
                UndefinedJsonConverter UndefinedJsonConverter = (UndefinedJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(role.UndefinedOption.Value.GetType()));
                UndefinedJsonConverter.WriteProperties(writer, role.UndefinedOption.Value, jsonSerializerOptions);
            }
