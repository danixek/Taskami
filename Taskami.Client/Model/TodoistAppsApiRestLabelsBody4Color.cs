...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class TodoistAppsApiRestLabelsBody4Color : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TodoistAppsApiRestLabelsBody4Color" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        internal TodoistAppsApiRestLabelsBody4Color(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<AnyOf1Enum?> IntOption { get; private set; }

        /// <summary>
        /// Gets or Sets Int
        /// </summary>
        public AnyOf1Enum? Int { get { return this.IntOption; } set { this.IntOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TodoistAppsApiRestLabelsBody4Color {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    public class AnyOf0Enum
    {
    }

    /// <summary>
    /// A Json converter for type <see cref="TodoistAppsApiRestLabelsBody4Color" />
    /// </summary>
    public class TodoistAppsApiRestLabelsBody4ColorJsonConverter : JsonConverter<TodoistAppsApiRestLabelsBody4Color>
    {
        /// <summary>
        /// Deserializes json to <see cref="TodoistAppsApiRestLabelsBody4Color" />
        /// </summary>
        ...
        public override TodoistAppsApiRestLabelsBody4Color Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            while (utf8JsonReaderAnyOf.Read())
            {
                ...
                if (utf8JsonReaderAnyOf.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReaderAnyOf.CurrentDepth - 1)
                {
                    ...
                    ClientUtils.TryDeserialize<AnyOf1Enum?>(ref utf8JsonReaderInt, jsonSerializerOptions, out varInt);
                }
            }
            ...
            return new TodoistAppsApiRestLabelsBody4Color(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="TodoistAppsApiRestLabelsBody4Color" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="todoistAppsApiRestLabelsBody4Color"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TodoistAppsApiRestLabelsBody4Color todoistAppsApiRestLabelsBody4Color, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (todoistAppsApiRestLabelsBody4Color.StringOption.IsSet && todoistAppsApiRestLabelsBody4Color.StringOption.Value != null)
                writer.WriteString("color", todoistAppsApiRestLabelsBody4Color.StringOption.Value);

            if (todoistAppsApiRestLabelsBody4Color.IntOption.IsSet && todoistAppsApiRestLabelsBody4Color.IntOption.Value != null)
                writer.WriteNumber("color", todoistAppsApiRestLabelsBody4Color.IntOption.Value.Value);

            WriteProperties(writer, todoistAppsApiRestLabelsBody4Color, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TodoistAppsApiRestLabelsBody4Color" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="todoistAppsApiRestLabelsBody4Color"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TodoistAppsApiRestLabelsBody4Color todoistAppsApiRestLabelsBody4Color, JsonSerializerOptions jsonSerializerOptions)
        {
