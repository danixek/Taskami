...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class PaginatedListCollaborator : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedListCollaborator" /> class.
        /// </summary>
        /// <param name="results">results</param>
        /// <param name="nextCursor">nextCursor</param>
        [JsonConstructor]
        public PaginatedListCollaborator(List<Collaborator> results, string? nextCursor = default)
        {
            Results = results;
        ...
        public List<Collaborator> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedListCollaborator {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="PaginatedListCollaborator" />
    /// </summary>
    public class PaginatedListCollaboratorJsonConverter : JsonConverter<PaginatedListCollaborator>
    {
        /// <summary>
        /// Deserializes json to <see cref="PaginatedListCollaborator" />
        /// </summary>
        ...
        public override PaginatedListCollaborator Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<Collaborator>?> results = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "results":
                            results = new Option<List<Collaborator>?>(JsonSerializer.Deserialize<List<Collaborator>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "next_cursor":
            ...
            if (!results.IsSet)
                throw new ArgumentException("Property is required for class PaginatedListCollaborator.", nameof(results));

            if (!nextCursor.IsSet)
                throw new ArgumentException("Property is required for class PaginatedListCollaborator.", nameof(nextCursor));

            if (results.IsSet && results.Value == null)
                throw new ArgumentNullException(nameof(results), "Property is not nullable for class PaginatedListCollaborator.");

            return new PaginatedListCollaborator(results.Value!, nextCursor.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="PaginatedListCollaborator" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paginatedListCollaborator"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PaginatedListCollaborator paginatedListCollaborator, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, paginatedListCollaborator, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PaginatedListCollaborator" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paginatedListCollaborator"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PaginatedListCollaborator paginatedListCollaborator, JsonSerializerOptions jsonSerializerOptions)
        {
            if (paginatedListCollaborator.Results == null)
                throw new ArgumentNullException(nameof(paginatedListCollaborator.Results), "Property is required for class PaginatedListCollaborator.");

            writer.WritePropertyName("results");
            JsonSerializer.Serialize(writer, paginatedListCollaborator.Results, jsonSerializerOptions);
            if (paginatedListCollaborator.NextCursor != null)
                writer.WriteString("next_cursor", paginatedListCollaborator.NextCursor);
            else
