...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class PaginatedListItemSyncView : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedListItemSyncView" /> class.
        /// </summary>
        /// <param name="results">results</param>
        /// <param name="nextCursor">nextCursor</param>
        [JsonConstructor]
        public PaginatedListItemSyncView(List<ItemSyncView> results, string? nextCursor = default)
        {
            Results = results;
        ...
        public List<ItemSyncView> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedListItemSyncView {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="PaginatedListItemSyncView" />
    /// </summary>
    public class PaginatedListItemSyncViewJsonConverter : JsonConverter<PaginatedListItemSyncView>
    {
        /// <summary>
        /// Deserializes json to <see cref="PaginatedListItemSyncView" />
        /// </summary>
        ...
        public override PaginatedListItemSyncView Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ItemSyncView>?> results = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "results":
                            results = new Option<List<ItemSyncView>?>(JsonSerializer.Deserialize<List<ItemSyncView>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "next_cursor":
            ...
            if (!results.IsSet)
                throw new ArgumentException("Property is required for class PaginatedListItemSyncView.", nameof(results));

            if (!nextCursor.IsSet)
                throw new ArgumentException("Property is required for class PaginatedListItemSyncView.", nameof(nextCursor));

            if (results.IsSet && results.Value == null)
                throw new ArgumentNullException(nameof(results), "Property is not nullable for class PaginatedListItemSyncView.");

            return new PaginatedListItemSyncView(results.Value!, nextCursor.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="PaginatedListItemSyncView" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paginatedListItemSyncView"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PaginatedListItemSyncView paginatedListItemSyncView, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, paginatedListItemSyncView, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PaginatedListItemSyncView" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paginatedListItemSyncView"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PaginatedListItemSyncView paginatedListItemSyncView, JsonSerializerOptions jsonSerializerOptions)
        {
            if (paginatedListItemSyncView.Results == null)
                throw new ArgumentNullException(nameof(paginatedListItemSyncView.Results), "Property is required for class PaginatedListItemSyncView.");

            writer.WritePropertyName("results");
            JsonSerializer.Serialize(writer, paginatedListItemSyncView.Results, jsonSerializerOptions);
            if (paginatedListItemSyncView.NextCursor != null)
                writer.WriteString("next_cursor", paginatedListItemSyncView.NextCursor);
            else
