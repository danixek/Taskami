...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class TodoistAppsApiSyncRestWorkspacesBody2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TodoistAppsApiSyncRestWorkspacesBody2" /> class.
        /// </summary>
        /// <param name="inviteCode">inviteCode</param>
        /// <param name="workspaceId">workspaceId</param>
        [JsonConstructor]
        public TodoistAppsApiSyncRestWorkspacesBody2(Option<string?> inviteCode = default, Option<int?> workspaceId = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<int?> WorkspaceIdOption { get; private set; }

        /// <summary>
        /// Gets or Sets WorkspaceId
        /// </summary>
        [JsonPropertyName("workspace_id")]
        public int? WorkspaceId { get { return this.WorkspaceIdOption; } set { this.WorkspaceIdOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TodoistAppsApiSyncRestWorkspacesBody2 {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="TodoistAppsApiSyncRestWorkspacesBody2" />
    /// </summary>
    public class TodoistAppsApiSyncRestWorkspacesBody2JsonConverter : JsonConverter<TodoistAppsApiSyncRestWorkspacesBody2>
    {
        /// <summary>
        /// Deserializes json to <see cref="TodoistAppsApiSyncRestWorkspacesBody2" />
        /// </summary>
        ...
        public override TodoistAppsApiSyncRestWorkspacesBody2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TodoistAppsApiSyncRestWorkspacesBody2(inviteCode, workspaceId);
        }

        /// <summary>
        /// Serializes a <see cref="TodoistAppsApiSyncRestWorkspacesBody2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="todoistAppsApiSyncRestWorkspacesBody2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TodoistAppsApiSyncRestWorkspacesBody2 todoistAppsApiSyncRestWorkspacesBody2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, todoistAppsApiSyncRestWorkspacesBody2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TodoistAppsApiSyncRestWorkspacesBody2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="todoistAppsApiSyncRestWorkspacesBody2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TodoistAppsApiSyncRestWorkspacesBody2 todoistAppsApiSyncRestWorkspacesBody2, JsonSerializerOptions jsonSerializerOptions)
        {
            if (todoistAppsApiSyncRestWorkspacesBody2.InviteCodeOption.IsSet)
                if (todoistAppsApiSyncRestWorkspacesBody2.InviteCodeOption.Value != null)
                    writer.WriteString("invite_code", todoistAppsApiSyncRestWorkspacesBody2.InviteCode);
                else
                    writer.WriteNull("invite_code");

            if (todoistAppsApiSyncRestWorkspacesBody2.WorkspaceIdOption.IsSet)
                if (todoistAppsApiSyncRestWorkspacesBody2.WorkspaceIdOption.Value != null)
                    writer.WriteNumber("workspace_id", todoistAppsApiSyncRestWorkspacesBody2.WorkspaceIdOption.Value!.Value);
                else
