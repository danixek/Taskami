...
namespace Org.OpenAPITools.Model
{
    ...
    /// DurationUnit
    /// </summary>
    public partial class DurationUnit : IValidatableObject
    {
        /// <summary>
        ...
        internal DurationUnit(Option<string?> @string, Option<Undefined?> undefined)
        {
            StringOption = @string;
    ...
    /// <summary>
    /// A Json converter for type <see cref="DurationUnit" />
    /// </summary>
    public class DurationUnitJsonConverter : JsonConverter<DurationUnit>
    {
        /// <summary>
        /// Deserializes json to <see cref="DurationUnit" />
        /// </summary>
        ...
        public override DurationUnit Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new DurationUnit(varStringParsedValue, undefinedParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="DurationUnit" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="durationUnit"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DurationUnit durationUnit, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (durationUnit.StringOption.IsSet && durationUnit.StringOption.Value != null)
                writer.WriteString("inner", durationUnit.StringOption.Value);

            if (durationUnit.UndefinedOption.IsSet && durationUnit.UndefinedOption.Value != null)
            {
                UndefinedJsonConverter UndefinedJsonConverter = (UndefinedJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(durationUnit.UndefinedOption.Value.GetType()));
                UndefinedJsonConverter.WriteProperties(writer, durationUnit.UndefinedOption.Value, jsonSerializerOptions);
            }

            WriteProperties(writer, durationUnit, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DurationUnit" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="durationUnit"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DurationUnit durationUnit, JsonSerializerOptions jsonSerializerOptions)
        {
