...
namespace Org.OpenAPITools.Model
{
    ...
    /// AssigneeId
    /// </summary>
    public partial class AssigneeId : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssigneeId" /> class.
        /// </summary>
        /// <param name="int"></param>
        /// <param name="undefined"></param>
        internal AssigneeId(Option<int?> @int, Option<Undefined?> undefined)
        {
            IntOption = @int;
    ...
    /// <summary>
    /// A Json converter for type <see cref="AssigneeId" />
    /// </summary>
    public class AssigneeIdJsonConverter : JsonConverter<AssigneeId>
    {
        /// <summary>
        /// Deserializes json to <see cref="AssigneeId" />
        /// </summary>
        ...
        public override AssigneeId Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AssigneeId(varIntParsedValue, undefinedParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="AssigneeId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="assigneeId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AssigneeId assigneeId, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (assigneeId.IntOption.IsSet && assigneeId.IntOption.Value != null)
                writer.WriteNumber("Priority", assigneeId.IntOption.Value.Value);

            if (assigneeId.UndefinedOption.IsSet && assigneeId.UndefinedOption.Value != null)
            {
                UndefinedJsonConverter UndefinedJsonConverter = (UndefinedJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(assigneeId.UndefinedOption.Value.GetType()));
                UndefinedJsonConverter.WriteProperties(writer, assigneeId.UndefinedOption.Value, jsonSerializerOptions);
            }

            WriteProperties(writer, assigneeId, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AssigneeId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="assigneeId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AssigneeId assigneeId, JsonSerializerOptions jsonSerializerOptions)
        {
