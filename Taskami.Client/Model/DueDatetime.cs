...
namespace Org.OpenAPITools.Model
{
    ...
    /// DueDatetime
    /// </summary>
    public partial class DueDatetime : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DueDatetime" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="undefined"></param>
        internal DueDatetime(Option<string?> @string, Option<Undefined?> undefined)
        {
            StringOption = @string;
    ...
    /// <summary>
    /// A Json converter for type <see cref="DueDatetime" />
    /// </summary>
    public class DueDatetimeJsonConverter : JsonConverter<DueDatetime>
    {
        /// <summary>
        /// Deserializes json to <see cref="DueDatetime" />
        /// </summary>
        ...
        public override DueDatetime Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new DueDatetime(varStringParsedValue, undefinedParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="DueDatetime" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dueDatetime"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DueDatetime dueDatetime, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (dueDatetime.StringOption.IsSet && dueDatetime.StringOption.Value != null)
                writer.WriteString("inner", dueDatetime.StringOption.Value);

            if (dueDatetime.UndefinedOption.IsSet && dueDatetime.UndefinedOption.Value != null)
            {
                UndefinedJsonConverter UndefinedJsonConverter = (UndefinedJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(dueDatetime.UndefinedOption.Value.GetType()));
                UndefinedJsonConverter.WriteProperties(writer, dueDatetime.UndefinedOption.Value, jsonSerializerOptions);
            }

            WriteProperties(writer, dueDatetime, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DueDatetime" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dueDatetime"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DueDatetime dueDatetime, JsonSerializerOptions jsonSerializerOptions)
        {
