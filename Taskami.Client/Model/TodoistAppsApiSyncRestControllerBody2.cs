...
{
    /// <summary>
    /// TodoistAppsApiSyncRestControllerBody2
    /// </summary>
    public partial class TodoistAppsApiSyncRestControllerBody2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TodoistAppsApiSyncRestControllerBody2" /> class.
        /// </summary>
        /// <param name="fileName">fileName</param>
        [JsonConstructor]
        public TodoistAppsApiSyncRestControllerBody2(Option<string?> fileName = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TodoistAppsApiSyncRestControllerBody2 {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="TodoistAppsApiSyncRestControllerBody2" />
    /// </summary>
    public class TodoistAppsApiSyncRestControllerBody2JsonConverter : JsonConverter<TodoistAppsApiSyncRestControllerBody2>
    {
        /// <summary>
        /// Deserializes json to <see cref="TodoistAppsApiSyncRestControllerBody2" />
        /// </summary>
        ...
        public override TodoistAppsApiSyncRestControllerBody2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TodoistAppsApiSyncRestControllerBody2(fileName);
        }

        /// <summary>
        /// Serializes a <see cref="TodoistAppsApiSyncRestControllerBody2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="todoistAppsApiSyncRestControllerBody2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TodoistAppsApiSyncRestControllerBody2 todoistAppsApiSyncRestControllerBody2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, todoistAppsApiSyncRestControllerBody2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TodoistAppsApiSyncRestControllerBody2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="todoistAppsApiSyncRestControllerBody2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TodoistAppsApiSyncRestControllerBody2 todoistAppsApiSyncRestControllerBody2, JsonSerializerOptions jsonSerializerOptions)
        {
            if (todoistAppsApiSyncRestControllerBody2.FileNameOption.IsSet)
                if (todoistAppsApiSyncRestControllerBody2.FileNameOption.Value != null)
                    writer.WriteString("file_name", todoistAppsApiSyncRestControllerBody2.FileName);
                else
