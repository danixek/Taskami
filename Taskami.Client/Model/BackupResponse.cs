...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class BackupResponse : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="varVersion">Date and time of the backup version</param>
        /// <param name="url">Backup URL</param>
        [JsonConstructor]
        public BackupResponse(string varVersion, string url)
        {
    ...
    public class BackupResponseJsonConverter : JsonConverter<BackupResponse>
    {
        ...
        public override BackupResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!varVersion.IsSet)
                throw new ArgumentException("Property is required for class BackupResponse.", nameof(varVersion));

            if (!url.IsSet)
                throw new ArgumentException("Property is required for class BackupResponse.", nameof(url));

            if (varVersion.IsSet && varVersion.Value == null)
                throw new ArgumentNullException(nameof(varVersion), "Property is not nullable for class BackupResponse.");

            if (url.IsSet && url.Value == null)
                throw new ArgumentNullException(nameof(url), "Property is not nullable for class BackupResponse.");

            return new BackupResponse(varVersion.Value!, url.Value!);
        }
        ...
        {
            if (backupResponse.VarVersion == null)
                throw new ArgumentNullException(nameof(backupResponse.VarVersion), "Property is required for class BackupResponse.");

            if (backupResponse.Url == null)
                throw new ArgumentNullException(nameof(backupResponse.Url), "Property is required for class BackupResponse.");

            writer.WriteString("version", backupResponse.VarVersion);

            writer.WriteString("url", backupResponse.Url);
        }
    }
}
