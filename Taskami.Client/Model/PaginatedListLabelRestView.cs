...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class PaginatedListLabelRestView : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedListLabelRestView" /> class.
        /// </summary>
        /// <param name="results">results</param>
        /// <param name="nextCursor">nextCursor</param>
        [JsonConstructor]
        public PaginatedListLabelRestView(List<LabelRestView> results, string? nextCursor = default)
        {
            Results = results;
        ...
        public List<LabelRestView> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedListLabelRestView {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="PaginatedListLabelRestView" />
    /// </summary>
    public class PaginatedListLabelRestViewJsonConverter : JsonConverter<PaginatedListLabelRestView>
    {
        /// <summary>
        /// Deserializes json to <see cref="PaginatedListLabelRestView" />
        /// </summary>
        ...
        public override PaginatedListLabelRestView Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<LabelRestView>?> results = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "results":
                            results = new Option<List<LabelRestView>?>(JsonSerializer.Deserialize<List<LabelRestView>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "next_cursor":
            ...
            if (!results.IsSet)
                throw new ArgumentException("Property is required for class PaginatedListLabelRestView.", nameof(results));

            if (!nextCursor.IsSet)
                throw new ArgumentException("Property is required for class PaginatedListLabelRestView.", nameof(nextCursor));

            if (results.IsSet && results.Value == null)
                throw new ArgumentNullException(nameof(results), "Property is not nullable for class PaginatedListLabelRestView.");

            return new PaginatedListLabelRestView(results.Value!, nextCursor.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="PaginatedListLabelRestView" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paginatedListLabelRestView"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PaginatedListLabelRestView paginatedListLabelRestView, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, paginatedListLabelRestView, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PaginatedListLabelRestView" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paginatedListLabelRestView"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PaginatedListLabelRestView paginatedListLabelRestView, JsonSerializerOptions jsonSerializerOptions)
        {
            if (paginatedListLabelRestView.Results == null)
                throw new ArgumentNullException(nameof(paginatedListLabelRestView.Results), "Property is required for class PaginatedListLabelRestView.");

            writer.WritePropertyName("results");
            JsonSerializer.Serialize(writer, paginatedListLabelRestView.Results, jsonSerializerOptions);
            if (paginatedListLabelRestView.NextCursor != null)
                writer.WriteString("next_cursor", paginatedListLabelRestView.NextCursor);
            else
