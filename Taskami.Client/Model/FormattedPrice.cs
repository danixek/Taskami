...
namespace Org.OpenAPITools.Model
{
    ...
    /// FormattedPrice
    /// </summary>
    public partial class FormattedPrice : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormattedPrice" /> class.
        /// </summary>
        /// <param name="currency">currency</param>
        /// <param name="unitAmount">unitAmount</param>
        /// <param name="taxBehavior">taxBehavior</param>
        [JsonConstructor]
        public FormattedPrice(string currency, int unitAmount, string taxBehavior)
        {
            Currency = currency;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FormattedPrice {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="FormattedPrice" />
    /// </summary>
    public class FormattedPriceJsonConverter : JsonConverter<FormattedPrice>
    {
        /// <summary>
        /// Deserializes json to <see cref="FormattedPrice" />
        /// </summary>
        ...
        public override FormattedPrice Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!currency.IsSet)
                throw new ArgumentException("Property is required for class FormattedPrice.", nameof(currency));

            if (!unitAmount.IsSet)
                throw new ArgumentException("Property is required for class FormattedPrice.", nameof(unitAmount));

            if (!taxBehavior.IsSet)
                throw new ArgumentException("Property is required for class FormattedPrice.", nameof(taxBehavior));

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class FormattedPrice.");

            if (unitAmount.IsSet && unitAmount.Value == null)
                throw new ArgumentNullException(nameof(unitAmount), "Property is not nullable for class FormattedPrice.");

            if (taxBehavior.IsSet && taxBehavior.Value == null)
                throw new ArgumentNullException(nameof(taxBehavior), "Property is not nullable for class FormattedPrice.");

            return new FormattedPrice(currency.Value!, unitAmount.Value!.Value!, taxBehavior.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="FormattedPrice" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="formattedPrice"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, FormattedPrice formattedPrice, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, formattedPrice, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="FormattedPrice" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="formattedPrice"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, FormattedPrice formattedPrice, JsonSerializerOptions jsonSerializerOptions)
        {
            if (formattedPrice.Currency == null)
                throw new ArgumentNullException(nameof(formattedPrice.Currency), "Property is required for class FormattedPrice.");

            if (formattedPrice.TaxBehavior == null)
                throw new ArgumentNullException(nameof(formattedPrice.TaxBehavior), "Property is required for class FormattedPrice.");

            writer.WriteString("currency", formattedPrice.Currency);

            writer.WriteNumber("unit_amount", formattedPrice.UnitAmount);

            writer.WriteString("tax_behavior", formattedPrice.TaxBehavior);
        }
    }
}
