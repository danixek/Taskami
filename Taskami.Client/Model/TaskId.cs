...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class TaskId : IValidatableObject
    {
        /// <summary>
        ...
        internal TaskId(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="TaskId" />
    /// </summary>
    public class TaskIdJsonConverter : JsonConverter<TaskId>
    {
        /// <summary>
        /// Deserializes json to <see cref="TaskId" />
        /// </summary>
        ...
        public override TaskId Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TaskId(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="TaskId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taskId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TaskId taskId, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (taskId.StringOption.IsSet && taskId.StringOption.Value != null)
                writer.WriteString("1", taskId.StringOption.Value);

            if (taskId.IntOption.IsSet && taskId.IntOption.Value != null)
                writer.WriteNumber("3", taskId.IntOption.Value.Value);

            WriteProperties(writer, taskId, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TaskId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taskId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TaskId taskId, JsonSerializerOptions jsonSerializerOptions)
        {
