...
namespace Org.OpenAPITools.Model
{
    ...
    /// SectionId
    /// </summary>
    public partial class SectionId : IValidatableObject
    {
        /// <summary>
        ...
        internal SectionId(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="SectionId" />
    /// </summary>
    public class SectionIdJsonConverter : JsonConverter<SectionId>
    {
        /// <summary>
        /// Deserializes json to <see cref="SectionId" />
        /// </summary>
        ...
        public override SectionId Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new SectionId(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="SectionId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sectionId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SectionId sectionId, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (sectionId.StringOption.IsSet && sectionId.StringOption.Value != null)
                writer.WriteString("1", sectionId.StringOption.Value);

            if (sectionId.IntOption.IsSet && sectionId.IntOption.Value != null)
                writer.WriteNumber("3", sectionId.IntOption.Value.Value);

            WriteProperties(writer, sectionId, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SectionId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sectionId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SectionId sectionId, JsonSerializerOptions jsonSerializerOptions)
        {
