...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class CommentId1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommentId1" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        internal CommentId1(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="CommentId1" />
    /// </summary>
    public class CommentId1JsonConverter : JsonConverter<CommentId1>
    {
        /// <summary>
        /// Deserializes json to <see cref="CommentId1" />
        /// </summary>
        ...
        public override CommentId1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new CommentId1(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="CommentId1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="commentId1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CommentId1 commentId1, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (commentId1.StringOption.IsSet && commentId1.StringOption.Value != null)
                writer.WriteString("1", commentId1.StringOption.Value);

            if (commentId1.IntOption.IsSet && commentId1.IntOption.Value != null)
                writer.WriteNumber("3", commentId1.IntOption.Value.Value);

            WriteProperties(writer, commentId1, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CommentId1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="commentId1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CommentId1 commentId1, JsonSerializerOptions jsonSerializerOptions)
        {
