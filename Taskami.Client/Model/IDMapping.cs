...
namespace Org.OpenAPITools.Model
{
    ...
    /// IDMapping
    /// </summary>
    public partial class IDMapping : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public IDMapping(string? oldId = default, string? newId = default)
        {
            OldId = oldId;
            NewId = newId;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="IDMapping" />
    /// </summary>
    public class IDMappingJsonConverter : JsonConverter<IDMapping>
    {
        /// <summary>
        /// Deserializes json to <see cref="IDMapping" />
        /// </summary>
        ...
        public override IDMapping Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> oldId = default;
            Option<string?> newId = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "old_id":
                            oldId = new Option<string?>(utf8JsonReader.GetString());
                            break;
                        case "new_id":
                            newId = new Option<string?>(utf8JsonReader.GetString());
                            break;
                        default:
                            break;
                    }
            ...
            if (!oldId.IsSet)
                throw new ArgumentException("Property is required for class IDMapping.", nameof(oldId));

            if (!newId.IsSet)
                throw new ArgumentException("Property is required for class IDMapping.", nameof(newId));

            return new IDMapping(oldId.Value!, newId.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="IDMapping" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="iDMapping"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, IDMapping iDMapping, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, iDMapping, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="IDMapping" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="iDMapping"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, IDMapping iDMapping, JsonSerializerOptions jsonSerializerOptions)
        {
            if (iDMapping.OldId != null)
                writer.WriteString("old_id", iDMapping.OldId);
            else
                writer.WriteNull("old_id");

            if (iDMapping.NewId != null)
                writer.WriteString("new_id", iDMapping.NewId);
            else
                writer.WriteNull("new_id");
        }
    }
}
