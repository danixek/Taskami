...
namespace Org.OpenAPITools.Model
{
    ...
    /// SectionId1
    /// </summary>
    public partial class SectionId1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SectionId1" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        internal SectionId1(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="SectionId1" />
    /// </summary>
    public class SectionId1JsonConverter : JsonConverter<SectionId1>
    {
        /// <summary>
        /// Deserializes json to <see cref="SectionId1" />
        /// </summary>
        ...
        public override SectionId1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new SectionId1(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="SectionId1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sectionId1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SectionId1 sectionId1, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (sectionId1.StringOption.IsSet && sectionId1.StringOption.Value != null)
                writer.WriteString("inner", sectionId1.StringOption.Value);

            if (sectionId1.IntOption.IsSet && sectionId1.IntOption.Value != null)
                writer.WriteNumber("3", sectionId1.IntOption.Value.Value);

            WriteProperties(writer, sectionId1, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SectionId1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sectionId1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SectionId1 sectionId1, JsonSerializerOptions jsonSerializerOptions)
        {
