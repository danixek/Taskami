...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Description : IValidatableObject
    {
        ...
        internal Description(Option<string?> @string, Option<Undefined?> undefined)
        {
            StringOption = @string;
    ...
    public class DescriptionJsonConverter : JsonConverter<Description>
    {
        ...
        public override Description Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Description(varStringParsedValue, undefinedParsedValue);
        }
        ...
        public override void Write(Utf8JsonWriter writer, Description description, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (description.StringOption.IsSet && description.StringOption.Value != null)
                writer.WriteString("inner", description.StringOption.Value);

            if (description.UndefinedOption.IsSet && description.UndefinedOption.Value != null)
            {
                UndefinedJsonConverter UndefinedJsonConverter = (UndefinedJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(description.UndefinedOption.Value.GetType()));
                UndefinedJsonConverter.WriteProperties(writer, description.UndefinedOption.Value, jsonSerializerOptions);
            }
