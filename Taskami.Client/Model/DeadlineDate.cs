...
namespace Org.OpenAPITools.Model
{
    ...
    /// DeadlineDate
    /// </summary>
    public partial class DeadlineDate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeadlineDate" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="undefined"></param>
        internal DeadlineDate(Option<string?> @string, Option<Undefined?> undefined)
        {
            StringOption = @string;
    ...
    /// <summary>
    /// A Json converter for type <see cref="DeadlineDate" />
    /// </summary>
    public class DeadlineDateJsonConverter : JsonConverter<DeadlineDate>
    {
        /// <summary>
        /// Deserializes json to <see cref="DeadlineDate" />
        /// </summary>
        ...
        public override DeadlineDate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new DeadlineDate(varStringParsedValue, undefinedParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="DeadlineDate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deadlineDate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DeadlineDate deadlineDate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (deadlineDate.StringOption.IsSet && deadlineDate.StringOption.Value != null)
                writer.WriteString("inner", deadlineDate.StringOption.Value);

            if (deadlineDate.UndefinedOption.IsSet && deadlineDate.UndefinedOption.Value != null)
            {
                UndefinedJsonConverter UndefinedJsonConverter = (UndefinedJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(deadlineDate.UndefinedOption.Value.GetType()));
                UndefinedJsonConverter.WriteProperties(writer, deadlineDate.UndefinedOption.Value, jsonSerializerOptions);
            }

            WriteProperties(writer, deadlineDate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DeadlineDate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deadlineDate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DeadlineDate deadlineDate, JsonSerializerOptions jsonSerializerOptions)
        {
