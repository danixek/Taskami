...
namespace Org.OpenAPITools.Model
{
    ...
    public class EmailResponseJsonConverter : JsonConverter<EmailResponse>
    {
        ...
        public override EmailResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!email.IsSet)
                throw new ArgumentException("Property is required for class EmailResponse.", nameof(email));

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class EmailResponse.");

            return new EmailResponse(email.Value!);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, EmailResponse emailResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (emailResponse.Email == null)
                throw new ArgumentNullException(nameof(emailResponse.Email), "Property is required for class EmailResponse.");

            writer.WriteString("email", emailResponse.Email);
        }
    }
}
