...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class MigratePersonalTokenResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MigratePersonalTokenResponse" /> class.
        /// </summary>
        /// <param name="tokenType">tokenType</param>
        /// <param name="accessToken">accessToken</param>
        [JsonConstructor]
        public MigratePersonalTokenResponse(TokenTypeEnum tokenType, string? accessToken = default)
        {
            TokenType = tokenType;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MigratePersonalTokenResponse {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MigratePersonalTokenResponse" />
    /// </summary>
    public class MigratePersonalTokenResponseJsonConverter : JsonConverter<MigratePersonalTokenResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="MigratePersonalTokenResponse" />
        /// </summary>
        ...
        public override MigratePersonalTokenResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<MigratePersonalTokenResponse.TokenTypeEnum?> tokenType = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "token_type":
                            ...
                            if (tokenTypeRawValue != null)
                                tokenType = new Option<MigratePersonalTokenResponse.TokenTypeEnum?>(MigratePersonalTokenResponse.TokenTypeEnumFromStringOrDefault(tokenTypeRawValue));
                            break;
                        case "access_token":
            ...
            if (!tokenType.IsSet)
                throw new ArgumentException("Property is required for class MigratePersonalTokenResponse.", nameof(tokenType));

            if (!accessToken.IsSet)
                throw new ArgumentException("Property is required for class MigratePersonalTokenResponse.", nameof(accessToken));

            if (tokenType.IsSet && tokenType.Value == null)
                throw new ArgumentNullException(nameof(tokenType), "Property is not nullable for class MigratePersonalTokenResponse.");

            return new MigratePersonalTokenResponse(tokenType.Value!.Value!, accessToken.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="MigratePersonalTokenResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="migratePersonalTokenResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MigratePersonalTokenResponse migratePersonalTokenResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, migratePersonalTokenResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MigratePersonalTokenResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="migratePersonalTokenResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MigratePersonalTokenResponse migratePersonalTokenResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            var tokenTypeRawValue = MigratePersonalTokenResponse.TokenTypeEnumToJsonValue(migratePersonalTokenResponse.TokenType);
            writer.WriteString("token_type", tokenTypeRawValue);
            if (migratePersonalTokenResponse.AccessToken != null)
                writer.WriteString("access_token", migratePersonalTokenResponse.AccessToken);
            else
