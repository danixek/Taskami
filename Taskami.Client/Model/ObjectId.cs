...
namespace Org.OpenAPITools.Model
{
    ...
    /// ObjectId
    /// </summary>
    public partial class ObjectId : IValidatableObject
    {
        /// <summary>
        ...
        internal ObjectId(Option<int?> @int, Option<string?> @string)
        {
            IntOption = @int;
            StringOption = @string;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="ObjectId" />
    /// </summary>
    public class ObjectIdJsonConverter : JsonConverter<ObjectId>
    {
        /// <summary>
        /// Deserializes json to <see cref="ObjectId" />
        /// </summary>
        ...
        public override ObjectId Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ObjectId(varIntParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="ObjectId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="objectId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ObjectId objectId, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (objectId.IntOption.IsSet && objectId.IntOption.Value != null)
                writer.WriteNumber("Priority", objectId.IntOption.Value.Value);

            if (objectId.StringOption.IsSet && objectId.StringOption.Value != null)
                writer.WriteString("Id", objectId.StringOption.Value);

            WriteProperties(writer, objectId, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ObjectId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="objectId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ObjectId objectId, JsonSerializerOptions jsonSerializerOptions)
        {
