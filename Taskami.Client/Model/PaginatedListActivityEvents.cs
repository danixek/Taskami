...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class PaginatedListActivityEvents : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedListActivityEvents" /> class.
        /// </summary>
        /// <param name="results">results</param>
        /// <param name="nextCursor">nextCursor</param>
        [JsonConstructor]
        public PaginatedListActivityEvents(List<ActivityEvents> results, string? nextCursor = default)
        {
            Results = results;
        ...
        public List<ActivityEvents> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedListActivityEvents {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="PaginatedListActivityEvents" />
    /// </summary>
    public class PaginatedListActivityEventsJsonConverter : JsonConverter<PaginatedListActivityEvents>
    {
        /// <summary>
        /// Deserializes json to <see cref="PaginatedListActivityEvents" />
        /// </summary>
        ...
        public override PaginatedListActivityEvents Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ActivityEvents>?> results = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "results":
                            results = new Option<List<ActivityEvents>?>(JsonSerializer.Deserialize<List<ActivityEvents>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "next_cursor":
            ...
            if (!results.IsSet)
                throw new ArgumentException("Property is required for class PaginatedListActivityEvents.", nameof(results));

            if (!nextCursor.IsSet)
                throw new ArgumentException("Property is required for class PaginatedListActivityEvents.", nameof(nextCursor));

            if (results.IsSet && results.Value == null)
                throw new ArgumentNullException(nameof(results), "Property is not nullable for class PaginatedListActivityEvents.");

            return new PaginatedListActivityEvents(results.Value!, nextCursor.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="PaginatedListActivityEvents" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paginatedListActivityEvents"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PaginatedListActivityEvents paginatedListActivityEvents, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, paginatedListActivityEvents, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PaginatedListActivityEvents" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paginatedListActivityEvents"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PaginatedListActivityEvents paginatedListActivityEvents, JsonSerializerOptions jsonSerializerOptions)
        {
            if (paginatedListActivityEvents.Results == null)
                throw new ArgumentNullException(nameof(paginatedListActivityEvents.Results), "Property is required for class PaginatedListActivityEvents.");

            writer.WritePropertyName("results");
            JsonSerializer.Serialize(writer, paginatedListActivityEvents.Results, jsonSerializerOptions);
            if (paginatedListActivityEvents.NextCursor != null)
                writer.WriteString("next_cursor", paginatedListActivityEvents.NextCursor);
            else
