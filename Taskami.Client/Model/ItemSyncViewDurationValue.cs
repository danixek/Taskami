...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class ItemSyncViewDurationValue : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemSyncViewDurationValue" /> class.
        /// </summary>
        /// <param name="int"></param>
        /// <param name="string"></param>
        internal ItemSyncViewDurationValue(Option<int?> @int, Option<string?> @string)
        {
            IntOption = @int;
            StringOption = @string;
            OnCreated();
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ItemSyncViewDurationValue {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ItemSyncViewDurationValue" />
    /// </summary>
    public class ItemSyncViewDurationValueJsonConverter : JsonConverter<ItemSyncViewDurationValue>
    {
        /// <summary>
        /// Deserializes json to <see cref="ItemSyncViewDurationValue" />
        /// </summary>
        ...
        public override ItemSyncViewDurationValue Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ItemSyncViewDurationValue(varIntParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="ItemSyncViewDurationValue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="itemSyncViewDurationValue"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ItemSyncViewDurationValue itemSyncViewDurationValue, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (itemSyncViewDurationValue.IntOption.IsSet && itemSyncViewDurationValue.IntOption.Value != null)
                writer.WriteNumber("Priority", itemSyncViewDurationValue.IntOption.Value.Value);

            if (itemSyncViewDurationValue.StringOption.IsSet && itemSyncViewDurationValue.StringOption.Value != null)
                writer.WriteString("value", itemSyncViewDurationValue.StringOption.Value);

            WriteProperties(writer, itemSyncViewDurationValue, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ItemSyncViewDurationValue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="itemSyncViewDurationValue"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ItemSyncViewDurationValue itemSyncViewDurationValue, JsonSerializerOptions jsonSerializerOptions)
        {
