...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Priority : IValidatableObject
    {
        ...
        internal Priority(Option<int?> @int, Option<Undefined?> undefined)
        {
            IntOption = @int;
    ...
    {
        /// <summary>
        /// Deserializes json to <see cref="Priority" />
        /// </summary>
        ...
        public override Priority Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Priority(varIntParsedValue, undefinedParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Priority" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="priority"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Priority priority, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (priority.IntOption.IsSet && priority.IntOption.Value != null)
                writer.WriteNumber("Priority", priority.IntOption.Value.Value);

            if (priority.UndefinedOption.IsSet && priority.UndefinedOption.Value != null)
            {
                UndefinedJsonConverter UndefinedJsonConverter = (UndefinedJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(priority.UndefinedOption.Value.GetType()));
                UndefinedJsonConverter.WriteProperties(writer, priority.UndefinedOption.Value, jsonSerializerOptions);
            }

            WriteProperties(writer, priority, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Priority" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="priority"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Priority priority, JsonSerializerOptions jsonSerializerOptions)
        {
