...
namespace Org.OpenAPITools.Model
{
    ...
    /// TaskId1
    /// </summary>
    public partial class TaskId1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskId1" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        internal TaskId1(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="TaskId1" />
    /// </summary>
    public class TaskId1JsonConverter : JsonConverter<TaskId1>
    {
        /// <summary>
        /// Deserializes json to <see cref="TaskId1" />
        /// </summary>
        ...
        public override TaskId1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TaskId1(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="TaskId1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taskId1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TaskId1 taskId1, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (taskId1.StringOption.IsSet && taskId1.StringOption.Value != null)
                writer.WriteString("1", taskId1.StringOption.Value);

            if (taskId1.IntOption.IsSet && taskId1.IntOption.Value != null)
                writer.WriteNumber("3", taskId1.IntOption.Value.Value);

            WriteProperties(writer, taskId1, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TaskId1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taskId1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TaskId1 taskId1, JsonSerializerOptions jsonSerializerOptions)
        {
