...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class TodoistAppsApiRestLabelsBody3Color : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TodoistAppsApiRestLabelsBody3Color" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        internal TodoistAppsApiRestLabelsBody3Color(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TodoistAppsApiRestLabelsBody3Color {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="TodoistAppsApiRestLabelsBody3Color" />
    /// </summary>
    public class TodoistAppsApiRestLabelsBody3ColorJsonConverter : JsonConverter<TodoistAppsApiRestLabelsBody3Color>
    {
        /// <summary>
        /// Deserializes json to <see cref="TodoistAppsApiRestLabelsBody3Color" />
        /// </summary>
        ...
        public override TodoistAppsApiRestLabelsBody3Color Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TodoistAppsApiRestLabelsBody3Color(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="TodoistAppsApiRestLabelsBody3Color" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="todoistAppsApiRestLabelsBody3Color"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TodoistAppsApiRestLabelsBody3Color todoistAppsApiRestLabelsBody3Color, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (todoistAppsApiRestLabelsBody3Color.StringOption.IsSet && todoistAppsApiRestLabelsBody3Color.StringOption.Value != null)
                writer.WriteString("color", todoistAppsApiRestLabelsBody3Color.StringOption.Value);

            if (todoistAppsApiRestLabelsBody3Color.IntOption.IsSet && todoistAppsApiRestLabelsBody3Color.IntOption.Value != null)
                writer.WriteNumber("color", todoistAppsApiRestLabelsBody3Color.IntOption.Value.Value);

            WriteProperties(writer, todoistAppsApiRestLabelsBody3Color, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TodoistAppsApiRestLabelsBody3Color" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="todoistAppsApiRestLabelsBody3Color"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TodoistAppsApiRestLabelsBody3Color todoistAppsApiRestLabelsBody3Color, JsonSerializerOptions jsonSerializerOptions)
        {
