...
namespace Org.OpenAPITools.Model
{
    ...
    /// DueString
    /// </summary>
    public partial class DueString : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DueString" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="undefined"></param>
        internal DueString(Option<string?> @string, Option<Undefined?> undefined)
        {
            StringOption = @string;
    ...
    /// <summary>
    /// A Json converter for type <see cref="DueString" />
    /// </summary>
    public class DueStringJsonConverter : JsonConverter<DueString>
    {
        /// <summary>
        /// Deserializes json to <see cref="DueString" />
        /// </summary>
        ...
        public override DueString Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new DueString(varStringParsedValue, undefinedParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="DueString" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dueString"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DueString dueString, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (dueString.StringOption.IsSet && dueString.StringOption.Value != null)
                writer.WriteString("inner", dueString.StringOption.Value);

            if (dueString.UndefinedOption.IsSet && dueString.UndefinedOption.Value != null)
            {
                UndefinedJsonConverter UndefinedJsonConverter = (UndefinedJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(dueString.UndefinedOption.Value.GetType()));
                UndefinedJsonConverter.WriteProperties(writer, dueString.UndefinedOption.Value, jsonSerializerOptions);
            }

            WriteProperties(writer, dueString, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DueString" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dueString"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DueString dueString, JsonSerializerOptions jsonSerializerOptions)
        {
