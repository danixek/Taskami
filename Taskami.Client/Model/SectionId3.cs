...
namespace Org.OpenAPITools.Model
{
    ...
    /// SectionId3
    /// </summary>
    public partial class SectionId3 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SectionId3" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        internal SectionId3(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="SectionId3" />
    /// </summary>
    public class SectionId3JsonConverter : JsonConverter<SectionId3>
    {
        /// <summary>
        /// Deserializes json to <see cref="SectionId3" />
        /// </summary>
        ...
        public override SectionId3 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new SectionId3(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="SectionId3" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sectionId3"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SectionId3 sectionId3, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (sectionId3.StringOption.IsSet && sectionId3.StringOption.Value != null)
                writer.WriteString("inner", sectionId3.StringOption.Value);

            if (sectionId3.IntOption.IsSet && sectionId3.IntOption.Value != null)
                writer.WriteNumber("3", sectionId3.IntOption.Value.Value);

            WriteProperties(writer, sectionId3, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SectionId3" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sectionId3"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SectionId3 sectionId3, JsonSerializerOptions jsonSerializerOptions)
        {
