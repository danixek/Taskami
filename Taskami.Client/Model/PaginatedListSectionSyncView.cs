...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class PaginatedListSectionSyncView : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedListSectionSyncView" /> class.
        /// </summary>
        /// <param name="results">results</param>
        /// <param name="nextCursor">nextCursor</param>
        [JsonConstructor]
        public PaginatedListSectionSyncView(List<SectionSyncView> results, string? nextCursor = default)
        {
            Results = results;
        ...
        public List<SectionSyncView> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedListSectionSyncView {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="PaginatedListSectionSyncView" />
    /// </summary>
    public class PaginatedListSectionSyncViewJsonConverter : JsonConverter<PaginatedListSectionSyncView>
    {
        /// <summary>
        /// Deserializes json to <see cref="PaginatedListSectionSyncView" />
        /// </summary>
        ...
        public override PaginatedListSectionSyncView Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<SectionSyncView>?> results = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "results":
                            results = new Option<List<SectionSyncView>?>(JsonSerializer.Deserialize<List<SectionSyncView>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "next_cursor":
            ...
            if (!results.IsSet)
                throw new ArgumentException("Property is required for class PaginatedListSectionSyncView.", nameof(results));

            if (!nextCursor.IsSet)
                throw new ArgumentException("Property is required for class PaginatedListSectionSyncView.", nameof(nextCursor));

            if (results.IsSet && results.Value == null)
                throw new ArgumentNullException(nameof(results), "Property is not nullable for class PaginatedListSectionSyncView.");

            return new PaginatedListSectionSyncView(results.Value!, nextCursor.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="PaginatedListSectionSyncView" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paginatedListSectionSyncView"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PaginatedListSectionSyncView paginatedListSectionSyncView, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, paginatedListSectionSyncView, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PaginatedListSectionSyncView" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paginatedListSectionSyncView"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PaginatedListSectionSyncView paginatedListSectionSyncView, JsonSerializerOptions jsonSerializerOptions)
        {
            if (paginatedListSectionSyncView.Results == null)
                throw new ArgumentNullException(nameof(paginatedListSectionSyncView.Results), "Property is required for class PaginatedListSectionSyncView.");

            writer.WritePropertyName("results");
            JsonSerializer.Serialize(writer, paginatedListSectionSyncView.Results, jsonSerializerOptions);
            if (paginatedListSectionSyncView.NextCursor != null)
                writer.WriteString("next_cursor", paginatedListSectionSyncView.NextCursor);
            else
