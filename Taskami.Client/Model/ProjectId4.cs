...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class ProjectId4 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectId4" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        internal ProjectId4(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="ProjectId4" />
    /// </summary>
    public class ProjectId4JsonConverter : JsonConverter<ProjectId4>
    {
        /// <summary>
        /// Deserializes json to <see cref="ProjectId4" />
        /// </summary>
        ...
        public override ProjectId4 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ProjectId4(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="ProjectId4" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectId4"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProjectId4 projectId4, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (projectId4.StringOption.IsSet && projectId4.StringOption.Value != null)
                writer.WriteString("inner", projectId4.StringOption.Value);

            if (projectId4.IntOption.IsSet && projectId4.IntOption.Value != null)
                writer.WriteNumber("3", projectId4.IntOption.Value.Value);

            WriteProperties(writer, projectId4, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ProjectId4" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectId4"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ProjectId4 projectId4, JsonSerializerOptions jsonSerializerOptions)
        {
