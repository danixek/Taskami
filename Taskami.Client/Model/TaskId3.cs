...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class TaskId3 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskId3" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        internal TaskId3(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="TaskId3" />
    /// </summary>
    public class TaskId3JsonConverter : JsonConverter<TaskId3>
    {
        /// <summary>
        /// Deserializes json to <see cref="TaskId3" />
        /// </summary>
        ...
        public override TaskId3 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TaskId3(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="TaskId3" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taskId3"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TaskId3 taskId3, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (taskId3.StringOption.IsSet && taskId3.StringOption.Value != null)
                writer.WriteString("inner", taskId3.StringOption.Value);

            if (taskId3.IntOption.IsSet && taskId3.IntOption.Value != null)
                writer.WriteNumber("3", taskId3.IntOption.Value.Value);

            WriteProperties(writer, taskId3, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TaskId3" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="taskId3"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TaskId3 taskId3, JsonSerializerOptions jsonSerializerOptions)
        {
