...
namespace Org.OpenAPITools.Model
{
    ...
    /// FileURLResponse
    /// </summary>
    public partial class FileURLResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileURLResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileURLResponse {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="FileURLResponse" />
    /// </summary>
    public class FileURLResponseJsonConverter : JsonConverter<FileURLResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="FileURLResponse" />
        /// </summary>
        ...
        public override FileURLResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!fileName.IsSet)
                throw new ArgumentException("Property is required for class FileURLResponse.", nameof(fileName));

            if (!fileUrl.IsSet)
                throw new ArgumentException("Property is required for class FileURLResponse.", nameof(fileUrl));

            if (fileName.IsSet && fileName.Value == null)
                throw new ArgumentNullException(nameof(fileName), "Property is not nullable for class FileURLResponse.");

            if (fileUrl.IsSet && fileUrl.Value == null)
                throw new ArgumentNullException(nameof(fileUrl), "Property is not nullable for class FileURLResponse.");

            return new FileURLResponse(fileName.Value!, fileUrl.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="FileURLResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="fileURLResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, FileURLResponse fileURLResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, fileURLResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="FileURLResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="fileURLResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, FileURLResponse fileURLResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (fileURLResponse.FileName == null)
                throw new ArgumentNullException(nameof(fileURLResponse.FileName), "Property is required for class FileURLResponse.");

            if (fileURLResponse.FileUrl == null)
                throw new ArgumentNullException(nameof(fileURLResponse.FileUrl), "Property is required for class FileURLResponse.");

            writer.WriteString("file_name", fileURLResponse.FileName);

            writer.WriteString("file_url", fileURLResponse.FileUrl);
        }
    }
}
