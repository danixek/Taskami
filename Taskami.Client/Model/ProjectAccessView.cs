...
namespace Org.OpenAPITools.Model
{
    ...
    /// ProjectAccessView
    /// </summary>
    public partial class ProjectAccessView : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectAccessView" /> class.
        /// </summary>
        /// <param name="visibility">visibility</param>
        /// <param name="varConfiguration">varConfiguration</param>
        [JsonConstructor]
        public ProjectAccessView(ProjectVisibility visibility, ModelConfiguration varConfiguration)
        {
        ...
        public ModelConfiguration VarConfiguration { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectAccessView {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ProjectAccessView" />
    /// </summary>
    public class ProjectAccessViewJsonConverter : JsonConverter<ProjectAccessView>
    {
        /// <summary>
        /// Deserializes json to <see cref="ProjectAccessView" />
        /// </summary>
        ...
        public override ProjectAccessView Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ProjectVisibility?> visibility = default;
            Option<ModelConfiguration?> varConfiguration = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "visibility":
                            ...
                            if (visibilityRawValue != null)
                                visibility = new Option<ProjectVisibility?>(ProjectVisibilityValueConverter.FromStringOrDefault(visibilityRawValue));
                            break;
                        case "configuration":
                            varConfiguration = new Option<ModelConfiguration?>(JsonSerializer.Deserialize<ModelConfiguration>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (!visibility.IsSet)
                throw new ArgumentException("Property is required for class ProjectAccessView.", nameof(visibility));

            if (!varConfiguration.IsSet)
                throw new ArgumentException("Property is required for class ProjectAccessView.", nameof(varConfiguration));

            if (visibility.IsSet && visibility.Value == null)
                throw new ArgumentNullException(nameof(visibility), "Property is not nullable for class ProjectAccessView.");

            if (varConfiguration.IsSet && varConfiguration.Value == null)
                throw new ArgumentNullException(nameof(varConfiguration), "Property is not nullable for class ProjectAccessView.");

            return new ProjectAccessView(visibility.Value!.Value!, varConfiguration.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="ProjectAccessView" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectAccessView"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProjectAccessView projectAccessView, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, projectAccessView, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ProjectAccessView" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectAccessView"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ProjectAccessView projectAccessView, JsonSerializerOptions jsonSerializerOptions)
        {
            if (projectAccessView.VarConfiguration == null)
                throw new ArgumentNullException(nameof(projectAccessView.VarConfiguration), "Property is required for class ProjectAccessView.");

            var visibilityRawValue = ProjectVisibilityValueConverter.ToJsonValue(projectAccessView.Visibility);
            writer.WriteString("visibility", visibilityRawValue);

            writer.WritePropertyName("configuration");
            JsonSerializer.Serialize(writer, projectAccessView.VarConfiguration, jsonSerializerOptions);
        }
    }
}
