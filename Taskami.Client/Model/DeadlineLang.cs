...
namespace Org.OpenAPITools.Model
{
    ...
    /// DeadlineLang
    /// </summary>
    public partial class DeadlineLang : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeadlineLang" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="undefined"></param>
        internal DeadlineLang(Option<string?> @string, Option<Undefined?> undefined)
        {
            StringOption = @string;
    ...
    /// <summary>
    /// A Json converter for type <see cref="DeadlineLang" />
    /// </summary>
    public class DeadlineLangJsonConverter : JsonConverter<DeadlineLang>
    {
        /// <summary>
        /// Deserializes json to <see cref="DeadlineLang" />
        /// </summary>
        ...
        public override DeadlineLang Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new DeadlineLang(varStringParsedValue, undefinedParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="DeadlineLang" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deadlineLang"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DeadlineLang deadlineLang, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (deadlineLang.StringOption.IsSet && deadlineLang.StringOption.Value != null)
                writer.WriteString("inner", deadlineLang.StringOption.Value);

            if (deadlineLang.UndefinedOption.IsSet && deadlineLang.UndefinedOption.Value != null)
            {
                UndefinedJsonConverter UndefinedJsonConverter = (UndefinedJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(deadlineLang.UndefinedOption.Value.GetType()));
                UndefinedJsonConverter.WriteProperties(writer, deadlineLang.UndefinedOption.Value, jsonSerializerOptions);
            }

            WriteProperties(writer, deadlineLang, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DeadlineLang" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deadlineLang"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DeadlineLang deadlineLang, JsonSerializerOptions jsonSerializerOptions)
        {
