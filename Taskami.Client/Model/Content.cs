...
namespace Org.OpenAPITools.Model
{
    ...
    /// Content
    /// </summary>
    public partial class Content : IValidatableObject
    {
        /// <summary>
        ...
        internal Content(Option<string?> @string, Option<Undefined?> undefined)
        {
            StringOption = @string;
    ...
    /// <summary>
    /// A Json converter for type <see cref="Content" />
    /// </summary>
    public class ContentJsonConverter : JsonConverter<Content>
    {
        /// <summary>
        /// Deserializes json to <see cref="Content" />
        /// </summary>
        ...
        public override Content Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Content(varStringParsedValue, undefinedParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Content" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="content"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Content content, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (content.StringOption.IsSet && content.StringOption.Value != null)
                writer.WriteString("inner", content.StringOption.Value);

            if (content.UndefinedOption.IsSet && content.UndefinedOption.Value != null)
            {
                UndefinedJsonConverter UndefinedJsonConverter = (UndefinedJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(content.UndefinedOption.Value.GetType()));
                UndefinedJsonConverter.WriteProperties(writer, content.UndefinedOption.Value, jsonSerializerOptions);
            }

            WriteProperties(writer, content, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Content" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="content"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Content content, JsonSerializerOptions jsonSerializerOptions)
        {
