...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class PaginatedListNoteSyncView : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedListNoteSyncView" /> class.
        /// </summary>
        /// <param name="results">results</param>
        /// <param name="nextCursor">nextCursor</param>
        [JsonConstructor]
        public PaginatedListNoteSyncView(List<NoteSyncView> results, string? nextCursor = default)
        {
            Results = results;
        ...
        public List<NoteSyncView> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedListNoteSyncView {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="PaginatedListNoteSyncView" />
    /// </summary>
    public class PaginatedListNoteSyncViewJsonConverter : JsonConverter<PaginatedListNoteSyncView>
    {
        /// <summary>
        /// Deserializes json to <see cref="PaginatedListNoteSyncView" />
        /// </summary>
        ...
        public override PaginatedListNoteSyncView Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<NoteSyncView>?> results = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "results":
                            results = new Option<List<NoteSyncView>?>(JsonSerializer.Deserialize<List<NoteSyncView>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "next_cursor":
            ...
            if (!results.IsSet)
                throw new ArgumentException("Property is required for class PaginatedListNoteSyncView.", nameof(results));

            if (!nextCursor.IsSet)
                throw new ArgumentException("Property is required for class PaginatedListNoteSyncView.", nameof(nextCursor));

            if (results.IsSet && results.Value == null)
                throw new ArgumentNullException(nameof(results), "Property is not nullable for class PaginatedListNoteSyncView.");

            return new PaginatedListNoteSyncView(results.Value!, nextCursor.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="PaginatedListNoteSyncView" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paginatedListNoteSyncView"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PaginatedListNoteSyncView paginatedListNoteSyncView, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, paginatedListNoteSyncView, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PaginatedListNoteSyncView" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="paginatedListNoteSyncView"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PaginatedListNoteSyncView paginatedListNoteSyncView, JsonSerializerOptions jsonSerializerOptions)
        {
            if (paginatedListNoteSyncView.Results == null)
                throw new ArgumentNullException(nameof(paginatedListNoteSyncView.Results), "Property is required for class PaginatedListNoteSyncView.");

            writer.WritePropertyName("results");
            JsonSerializer.Serialize(writer, paginatedListNoteSyncView.Results, jsonSerializerOptions);
            if (paginatedListNoteSyncView.NextCursor != null)
                writer.WriteString("next_cursor", paginatedListNoteSyncView.NextCursor);
            else
