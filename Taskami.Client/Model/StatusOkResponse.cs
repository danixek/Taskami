...
namespace Org.OpenAPITools.Model
{
    ...
    /// StatusOkResponse
    /// </summary>
    public partial class StatusOkResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StatusOkResponse" /> class.
        /// </summary>
        /// <param name="status">status</param>
        [JsonConstructor]
        public StatusOkResponse(StatusEnum status)
        {
            Status = status;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StatusOkResponse {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="StatusOkResponse" />
    /// </summary>
    public class StatusOkResponseJsonConverter : JsonConverter<StatusOkResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="StatusOkResponse" />
        /// </summary>
        ...
        public override StatusOkResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<StatusOkResponse.StatusEnum?> status = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<StatusOkResponse.StatusEnum?>(StatusOkResponse.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!status.IsSet)
                throw new ArgumentException("Property is required for class StatusOkResponse.", nameof(status));

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class StatusOkResponse.");

            return new StatusOkResponse(status.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="StatusOkResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="statusOkResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, StatusOkResponse statusOkResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, statusOkResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="StatusOkResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="statusOkResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, StatusOkResponse statusOkResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            var statusRawValue = StatusOkResponse.StatusEnumToJsonValue(statusOkResponse.Status);
