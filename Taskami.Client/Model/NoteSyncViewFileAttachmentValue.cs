...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class NoteSyncViewFileAttachmentValue : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NoteSyncViewFileAttachmentValue" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        /// <param name="list"></param>
        /// <param name="dictionary"></param>
        internal NoteSyncViewFileAttachmentValue(Option<string?> @string, Option<int?> @int, Option<List?> list, Option<Dictionary?> dictionary)
        {
            StringOption = @string;
            IntOption = @int;
            ListOption = list;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<Dictionary<string, Object>?> DictionaryOption { get; private set; }

        /// <summary>
        /// Gets or Sets Dictionary
        /// </summary>
        public Dictionary<string, Object>? Dictionary { get { return this.DictionaryOption; } set { this.DictionaryOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NoteSyncViewFileAttachmentValue {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="NoteSyncViewFileAttachmentValue" />
    /// </summary>
    public class NoteSyncViewFileAttachmentValueJsonConverter : JsonConverter<NoteSyncViewFileAttachmentValue>
    {
        /// <summary>
        /// Deserializes json to <see cref="NoteSyncViewFileAttachmentValue" />
        /// </summary>
        ...
        public override NoteSyncViewFileAttachmentValue Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            while (utf8JsonReaderAnyOf.Read())
            {
                ...
                if (utf8JsonReaderAnyOf.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReaderAnyOf.CurrentDepth - 1)
                {
                    ...
                    ClientUtils.TryDeserialize<Dictionary<string, Object>?>(ref utf8JsonReaderDictionary, jsonSerializerOptions, out dictionary);
                }
            }
            ...
            Option<Dictionary?> dictionaryParsedValue = dictionary == null
                ? default
                : new Option<Dictionary?>(dictionary);

            return new NoteSyncViewFileAttachmentValue(varStringParsedValue, varIntParsedValue, listParsedValue, dictionaryParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="NoteSyncViewFileAttachmentValue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="noteSyncViewFileAttachmentValue"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, NoteSyncViewFileAttachmentValue noteSyncViewFileAttachmentValue, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (noteSyncViewFileAttachmentValue.StringOption.IsSet && noteSyncViewFileAttachmentValue.StringOption.Value != null)
                writer.WriteString("inner", noteSyncViewFileAttachmentValue.StringOption.Value);

            if (noteSyncViewFileAttachmentValue.IntOption.IsSet && noteSyncViewFileAttachmentValue.IntOption.Value != null)
                writer.WriteNumber("inner", noteSyncViewFileAttachmentValue.IntOption.Value.Value);

            if (noteSyncViewFileAttachmentValue.ListOption.IsSet && noteSyncViewFileAttachmentValue.ListOption.Value != null)

            if (noteSyncViewFileAttachmentValue.DictionaryOption.IsSet && noteSyncViewFileAttachmentValue.DictionaryOption.Value != null)

            WriteProperties(writer, noteSyncViewFileAttachmentValue, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="NoteSyncViewFileAttachmentValue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="noteSyncViewFileAttachmentValue"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, NoteSyncViewFileAttachmentValue noteSyncViewFileAttachmentValue, JsonSerializerOptions jsonSerializerOptions)
        {
