...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class ProjectId1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectId1" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        internal ProjectId1(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="ProjectId1" />
    /// </summary>
    public class ProjectId1JsonConverter : JsonConverter<ProjectId1>
    {
        /// <summary>
        /// Deserializes json to <see cref="ProjectId1" />
        /// </summary>
        ...
        public override ProjectId1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ProjectId1(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="ProjectId1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectId1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProjectId1 projectId1, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (projectId1.StringOption.IsSet && projectId1.StringOption.Value != null)
                writer.WriteString("1", projectId1.StringOption.Value);

            if (projectId1.IntOption.IsSet && projectId1.IntOption.Value != null)
                writer.WriteNumber("3", projectId1.IntOption.Value.Value);

            WriteProperties(writer, projectId1, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ProjectId1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectId1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ProjectId1 projectId1, JsonSerializerOptions jsonSerializerOptions)
        {
