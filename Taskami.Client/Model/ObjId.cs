...
namespace Org.OpenAPITools.Model
{
    ...
    /// ObjId
    /// </summary>
    public partial class ObjId : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjId" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="int"></param>
        internal ObjId(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="ObjId" />
    /// </summary>
    public class ObjIdJsonConverter : JsonConverter<ObjId>
    {
        /// <summary>
        /// Deserializes json to <see cref="ObjId" />
        /// </summary>
        ...
        public override ObjId Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ObjId(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="ObjId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="objId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ObjId objId, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (objId.StringOption.IsSet && objId.StringOption.Value != null)
                writer.WriteString("inner", objId.StringOption.Value);

            if (objId.IntOption.IsSet && objId.IntOption.Value != null)
                writer.WriteNumber("3", objId.IntOption.Value.Value);

            WriteProperties(writer, objId, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ObjId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="objId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ObjId objId, JsonSerializerOptions jsonSerializerOptions)
        {
