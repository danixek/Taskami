...
namespace Org.OpenAPITools.Model
{
    ...
    /// DueLang
    /// </summary>
    public partial class DueLang : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DueLang" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="undefined"></param>
        internal DueLang(Option<string?> @string, Option<Undefined?> undefined)
        {
            StringOption = @string;
    ...
    /// <summary>
    /// A Json converter for type <see cref="DueLang" />
    /// </summary>
    public class DueLangJsonConverter : JsonConverter<DueLang>
    {
        /// <summary>
        /// Deserializes json to <see cref="DueLang" />
        /// </summary>
        ...
        public override DueLang Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new DueLang(varStringParsedValue, undefinedParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="DueLang" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dueLang"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DueLang dueLang, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (dueLang.StringOption.IsSet && dueLang.StringOption.Value != null)
                writer.WriteString("inner", dueLang.StringOption.Value);

            if (dueLang.UndefinedOption.IsSet && dueLang.UndefinedOption.Value != null)
            {
                UndefinedJsonConverter UndefinedJsonConverter = (UndefinedJsonConverter) jsonSerializerOptions.Converters.First(c => c.CanConvert(dueLang.UndefinedOption.Value.GetType()));
                UndefinedJsonConverter.WriteProperties(writer, dueLang.UndefinedOption.Value, jsonSerializerOptions);
            }

            WriteProperties(writer, dueLang, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DueLang" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dueLang"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DueLang dueLang, JsonSerializerOptions jsonSerializerOptions)
        {
