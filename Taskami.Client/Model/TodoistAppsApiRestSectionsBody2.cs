...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class TodoistAppsApiRestSectionsBody2 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TodoistAppsApiRestSectionsBody2" /> class.
        /// </summary>
        /// <param name="name">name</param>
        [JsonConstructor]
        public TodoistAppsApiRestSectionsBody2(Option<string?> name = default)
        {
            NameOption = name;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TodoistAppsApiRestSectionsBody2 {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="TodoistAppsApiRestSectionsBody2" />
    /// </summary>
    public class TodoistAppsApiRestSectionsBody2JsonConverter : JsonConverter<TodoistAppsApiRestSectionsBody2>
    {
        /// <summary>
        /// Deserializes json to <see cref="TodoistAppsApiRestSectionsBody2" />
        /// </summary>
        ...
        public override TodoistAppsApiRestSectionsBody2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new TodoistAppsApiRestSectionsBody2(name);
        }

        /// <summary>
        /// Serializes a <see cref="TodoistAppsApiRestSectionsBody2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="todoistAppsApiRestSectionsBody2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TodoistAppsApiRestSectionsBody2 todoistAppsApiRestSectionsBody2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, todoistAppsApiRestSectionsBody2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TodoistAppsApiRestSectionsBody2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="todoistAppsApiRestSectionsBody2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TodoistAppsApiRestSectionsBody2 todoistAppsApiRestSectionsBody2, JsonSerializerOptions jsonSerializerOptions)
        {
            if (todoistAppsApiRestSectionsBody2.NameOption.IsSet)
                if (todoistAppsApiRestSectionsBody2.NameOption.Value != null)
                    writer.WriteString("name", todoistAppsApiRestSectionsBody2.Name);
                else
