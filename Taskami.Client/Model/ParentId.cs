...
namespace Org.OpenAPITools.Model
{
    ...
    /// ParentId
    /// </summary>
    public partial class ParentId : IValidatableObject
    {
        /// <summary>
        ...
        internal ParentId(Option<string?> @string, Option<int?> @int)
        {
            StringOption = @string;
            IntOption = @int;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="ParentId" />
    /// </summary>
    public class ParentIdJsonConverter : JsonConverter<ParentId>
    {
        /// <summary>
        /// Deserializes json to <see cref="ParentId" />
        /// </summary>
        ...
        public override ParentId Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ParentId(varStringParsedValue, varIntParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="ParentId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="parentId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ParentId parentId, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (parentId.StringOption.IsSet && parentId.StringOption.Value != null)
                writer.WriteString("inner", parentId.StringOption.Value);

            if (parentId.IntOption.IsSet && parentId.IntOption.Value != null)
                writer.WriteNumber("3", parentId.IntOption.Value.Value);

            WriteProperties(writer, parentId, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ParentId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="parentId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ParentId parentId, JsonSerializerOptions jsonSerializerOptions)
        {
