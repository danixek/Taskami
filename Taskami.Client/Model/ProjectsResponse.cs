...
namespace Org.OpenAPITools.Model
{
    ...
    /// ProjectsResponse
    /// </summary>
    public partial class ProjectsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectsResponse" /> class.
        /// </summary>
        /// <param name="hasMore">hasMore</param>
        /// <param name="workspaceProjects">workspaceProjects</param>
        /// <param name="nextCursor">nextCursor</param>
        [JsonConstructor]
        public ProjectsResponse(bool hasMore, List<WorkspaceProjectView> workspaceProjects, Option<string?> nextCursor = default)
        {
            HasMore = hasMore;
        ...
        /// <summary>
        /// Gets or Sets WorkspaceProjects
        /// </summary>
        [JsonPropertyName("workspace_projects")]
        public List<WorkspaceProjectView> WorkspaceProjects { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WorkspaceProjects: ").Append(WorkspaceProjects).Append("\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ProjectsResponse" />
    /// </summary>
    public class ProjectsResponseJsonConverter : JsonConverter<ProjectsResponse>
    {
        /// <summary>
        /// Deserializes json to <see cref="ProjectsResponse" />
        /// </summary>
        ...
        public override ProjectsResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<WorkspaceProjectView>?> workspaceProjects = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "workspace_projects":
                            workspaceProjects = new Option<List<WorkspaceProjectView>?>(JsonSerializer.Deserialize<List<WorkspaceProjectView>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "next_cursor":
            ...
            if (!hasMore.IsSet)
                throw new ArgumentException("Property is required for class ProjectsResponse.", nameof(hasMore));

            if (!workspaceProjects.IsSet)
                throw new ArgumentException("Property is required for class ProjectsResponse.", nameof(workspaceProjects));

            if (hasMore.IsSet && hasMore.Value == null)
                throw new ArgumentNullException(nameof(hasMore), "Property is not nullable for class ProjectsResponse.");

            if (workspaceProjects.IsSet && workspaceProjects.Value == null)
                throw new ArgumentNullException(nameof(workspaceProjects), "Property is not nullable for class ProjectsResponse.");

            if (nextCursor.IsSet && nextCursor.Value == null)
                throw new ArgumentNullException(nameof(nextCursor), "Property is not nullable for class ProjectsResponse.");

            return new ProjectsResponse(hasMore.Value!.Value!, workspaceProjects.Value!, nextCursor);
        }

        /// <summary>
        /// Serializes a <see cref="ProjectsResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectsResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProjectsResponse projectsResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, projectsResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ProjectsResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectsResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ProjectsResponse projectsResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (projectsResponse.WorkspaceProjects == null)
                throw new ArgumentNullException(nameof(projectsResponse.WorkspaceProjects), "Property is required for class ProjectsResponse.");

            if (projectsResponse.NextCursorOption.IsSet && projectsResponse.NextCursor == null)
                throw new ArgumentNullException(nameof(projectsResponse.NextCursor), "Property is required for class ProjectsResponse.");

            writer.WriteBoolean("has_more", projectsResponse.HasMore);

            writer.WritePropertyName("workspace_projects");
            JsonSerializer.Serialize(writer, projectsResponse.WorkspaceProjects, jsonSerializerOptions);
            if (projectsResponse.NextCursorOption.IsSet)
                writer.WriteString("next_cursor", projectsResponse.NextCursor);
        }
    }
}
